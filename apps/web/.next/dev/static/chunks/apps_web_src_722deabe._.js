...
"[project]/apps/web/src/infrastructure/CacheService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$CacheService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/infrastructure/CacheService.ts [app-client] (ecmascript)");
;
class RadioDiscoveryService {
    baseUrl = "https://de1.api.radio-browser.info/json";
    cache = new Map();
    cacheExpiry = 5 * 60 * 1000;
    diskCacheExpiry = 24 * 60 * 60 * 1000;
    isInitialized = false;
    async initialize() {
        if (!this.isInitialized) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$CacheService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheService"].initialize();
            this.isInitialized = true;
        }
    }
    /**
   * Get ALL stations from Radio Browser API with persistent caching
   */ async getAllStations() {
        await this.initialize();
        const cacheKey = 'all_stations';
        try {
            // Check IndexedDB cache first
            const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$CacheService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheService"].get(cacheKey);
            const isStale = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$CacheService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheService"].isStale(cacheKey, this.diskCacheExpiry);
            // Return cached data immediately if available and fresh
            if (cached && !isStale) {
                console.log(`Returning ${cached.data.length} cached stations from IndexedDB`);
                return cached.data;
            }
            // If stale, return cached data but refresh in background
            if (cached && isStale) {
                console.log(`Returning ${cached.data.length} stale stations, refreshing in background...`);
                this.refreshAllStationsInBackground(cacheKey);
                return cached.data;
            }
            // No cache, fetch fresh data
            console.log('Fetching all stations from API...');
            const stations = await this.fetchAllStationsFromAPI();
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$CacheService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheService"].set(cacheKey, stations);
            return stations;
        } catch (error) {
   ...
   */ async refreshAllStationsInBackground(cacheKey) {
        try {
            const stations = await this.fetchAllStationsFromAPI();
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$CacheService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cacheService"].set(cacheKey, stations);
            console.log(`Background refresh completed: ${stations.length} stations`);
        } catch (error) {
            console.warn('Background refresh failed:', error);
        }
    }
    /**
   * Fetch all stations from the API (up to 50,000 limit)
   */ async fetchAllStationsFromAPI() {
        const response = await fetch(`${this.baseUrl}/stations?limit=50000&hidebroken=true&order=clickcount&reverse=true`);
        if (!response.ok) {
   ...
   */ async getGlobalStationsWithDistribution() {
        ...
        try {
            ...
            const stationPromises = majorRegions.map((country)=>this.getStationsByCountry(country, 100).catch(()=>[]));
            ...
            const globalTop = await this.fetchTopStationsByVotes(500);
            const combined = [
                ...allStations,
                ...globalTop
            ];
...
class RadioStationService {
   ...
   */ async getStationsByCountry(country, includeOnline = true) {
        try {
            ...
            const globalStations = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$radioDiscoveryService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["radioDiscoveryService"].getGlobalStationsWithDistribution();
            ...
            const fetchData = {
                "SearchPanel.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        const cities = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$radioStationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["radioStationService"].getAvailableCities();
                    ...
                    "SearchPanel.useEffect": async ()=>{
                        ...
                        try {
                            ...
                            const sortedResults = results.sort({
                                "SearchPanel.useEffect.sortedResults": (a, b)=>b.listeners - a.listeners
                            }["SearchPanel.useEffect.sortedResults"]) // Sort by popularity
...
_s(SearchPanel, "UPro9OSwTiKjJo5myayWVSuaW5g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$stores$2f$globe$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGlobeStore"]
    ];
});
...
//# sourceMappingURL=apps_web_src_722deabe._.js.map