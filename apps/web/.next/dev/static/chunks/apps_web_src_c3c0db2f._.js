...
function ClusteredStationMarkers() {
    ...
    const { markers, selectStation, hoverStation, selectedStation } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$stores$2f$globe$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGlobeStore"])();
    ...
    const [hoveredCluster, setHoveredCluster] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Calculate camera distance to determine zoom level
    const cameraDistance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ClusteredStationMarkers.useMemo[cameraDistance]": ()=>{
            return camera.position.length();
        }
    }["ClusteredStationMarkers.useMemo[cameraDistance]"], [
        camera.position
    ]);
    // Cluster stations by city/region based on zoom level
    const clusters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ClusteredStationMarkers.useMemo[clusters]": ()=>{
            const clusterMap = new Map();
            markers.forEach({
                "ClusteredStationMarkers.useMemo[clusters]": (marker)=>{
                    ...
                    if (!clusterMap.has(cityKey)) {
                        clusterMap.set(cityKey, {
                            ...
                            isVisible: true,
                            zoomLevel: cameraDistance > 8 ? 1 : cameraDistance > 4 ? 2 : 3
                        });
                    }
    ...
    // Determine marker size based on camera distance and station count
    const getMarkerSize = (cluster)=>{
        const baseSize = Math.max(0.08, Math.min(0.25, 0.4 / cameraDistance));
        const stationMultiplier = Math.log(cluster.stations.length + 1) * 0.3;
        return baseSize + stationMultiplier;
    };
    // Get marker color based on cluster properties
    const getMarkerColor = (cluster)=>{
        const hasSelected = cluster.stations.some((s)=>s.id === selectedStation?.id);
        const isHovered = hoveredCluster === cluster.id;
        if (hasSelected) return "#00ff88";
        if (isHovered) return "#00d4ff";
        // Color based on station count
        const count = cluster.stations.length;
        if (count > 20) return "#ff4757"; // High density - red
        if (count > 10) return "#ffa502"; // Medium density - orange  
        if (count > 5) return "#ffde59"; // Low-medium density - yellow
        return "#5f72ff"; // Low density - blue
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$5a94e5eb$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
    ...
    const handleClusterClick = (cluster, event)=>{
        ...
        // If only one station in cluster, select it directly
        if (cluster.stations.length === 1) {
            selectStation(cluster.stations[0]);
            return;
        }
        // For multiple stations, show cluster expansion or list
        // For now, select the most popular station
        const popularStation = cluster.stations.reduce((prev, current)=>current.listeners > prev.listeners ? current : prev);
        selectStation(popularStation);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
        ref: markersRef,
        children: clusters.map((cluster)=>{
            const markerSize = getMarkerSize(cluster);
            const markerColor = getMarkerColor(cluster);
            const shouldShowLabel = cameraDistance < 6 && cluster.stations.length > 3;
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
                ...
                children: [
                    ...
                    cluster.stations.some((s)=>s.id === selectedStation?.id) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("mesh", {
                        children: [
                    ...
                    hoveredCluster === cluster.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("mesh", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ringGeometry", {
                                args: [
                                    markerSize * 1.1,
                    ...
                    cluster.stations.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Text$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Text"], {
                        position: [
                            0,
                            0,
                            0.002
                        ...
                        children: cluster.stations.length
                    }, void 0, false, {
                        fileName: "[project]/apps/web/src/components/ClusteredStationMarkers.tsx",
                        lineNumber: 195,
                        columnNumber: 15
                    }, this),
                    shouldShowLabel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Text$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Text"], {
                        position: [
                            0,
                            -markerSize * 1.8,
                            0
...
_s(ClusteredStationMarkers, "bPI5Y7V7nr5fQuWpAVuwNCyH6X8=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_src_c3c0db2f._.js.map