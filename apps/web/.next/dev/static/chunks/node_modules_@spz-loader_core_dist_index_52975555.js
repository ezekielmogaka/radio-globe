...
"[project]/node_modules/@spz-loader/core/dist/index.js (static in ecmascript)", ((__turbopack_context__) => {

__turbopack_context__.v("/_next/static/media/index.f844ed46.js");}),
"[project]/node_modules/@spz-loader/core/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/apps/web/node_modules/next/dist/compiled/buffer/index.js [app-client] (ecmascript)");
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/@spz-loader/core/dist/index.js")}`;
    }
};
async function TI(R = {}) {
    var DI;
    var s, i = R, L = typeof window == "object", k = typeof WorkerGlobalScope < "u", f = typeof __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] == "object" && ((DI = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].versions) == null ? void 0 : DI.node) && __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].type != "renderer";
    if (f) {
        const { createRequire: I } = await Promise.resolve().then(()=>bI);
        var r = I(__TURBOPACK__import$2e$meta__.url);
    }
    var x = "./this.program", p = __TURBOPACK__import$2e$meta__.url, $;
    if (f) {
        var wI = r("fs");
        p.startsWith("file:") && r("path").dirname(r("url").fileURLToPath(p)), $ = (I)=>(I = oI(I) ? new URL(I) : I, wI.readFileSync(I)), 1 < __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].argv.length && (x = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].argv[1].replace(/\\/g, "/")), __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].argv.slice(2);
    } else if (L || k) {
        try {
            new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/@spz-loader/core/dist/index.js (static in ecmascript)"));
        } catch  {}
        k && ($ = (I)=>{
    ...
    var VA = (I)=>{
        ...
        if (f) return I = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(I, "base64"), new Uint8Array(I.buffer, I.byteOffset, I.length);
    ...
    }, aA = !1, OA = ()=>{}, b = (I)=>typeof FinalizationRegistry > "u" ? (b = (A)=>A, I) : (aA = new FinalizationRegistry((A)=>{
            A = A.L, --A.count.value, A.count.value === 0 && (A.S ? A.W.Y(A.S) : A.P.M.Y(A.O));
        }), b = (A)=>{
            var g = A.L;
            return g.S && aA.register(A, {
                L: g
            }, A), A;
        }, OA = (A)=>{
            aA.unregister(A);
    ...
    function DA() {}
    var iA = (I, A)=>Object.defineProperty(A, "name", {
            value: I
        }), PA = {}, uA = (I, A, g)=>{
        if (I[A].R === void 0) {
            var B = I[A];
    ...
    function SA(I, A, g, B, Q, E) {
        ...
        for(B = [
            ...
            sA,
            F.N.bind(F),
            w == null ? void 0 : w.T.bind(w)
        ], Q = 2; Q < C; ++Q)F = A[Q], B.push(F.T.bind(F));
        if (!o) for(Q = D ? 1 : 2; Q < A.length; ++Q)A[Q].V !== null && B.push(A[Q].V);
        for(o = $A(A), Q = A.length - 2, w = [], F = [
            "fn"
        ], D && F.push("thisWired"), C = 0; C < Q; ++C)w.push(`arg${C}`), F.push(`arg${C}Wired`);
...
`)(...B), iA(I, A);
    ...
    for(var _A = (I)=>{
        ...
        [],
        []
    ], t = new Uint8Array(123), n = 25; 0 <= n; --n)t[48 + n] = 52 + n, t[65 + n] = n, t[97 + n] = 26 + n;
    t[43] = 62, t[47] = 63, (()=>{
        let I = DA.prototype;
        Object.assign(I, {
            isAliasOf: function(g) {
        ...
        N: function(I) {
            ...
            var B = LI(this.M, g);
            if (B !== void 0) return B.L.count.value === 0 ? (B.L.O = g, B.L.S = I, B.clone()) : (B = B.clone(), this.ka(I), B);
            if (B = this.M.ra(g), B = PA[B], !B) return A.call(this);
            B = this.fa ? B.oa : B.pointerType;
            var Q = mA(g, this.M, B.M);
            return Q === null ? A.call(this) : this.ga ? wA(B.M.$, {
                P: B,
                O: Q,
                W: this,
                S: I
    ...
    var EI, KA, q, XI = {
        ...
        n: (I, A, g, B, Q)=>{
            ...
            J(I, {
                name: A,
                N: E,
                T: (C, D)=>(typeof D == "number" && (D = BigInt(D)), D),
                X: pA(A, g, !B),
                V: null
            });
        },
        ...
        j: (I, A, g, B, Q, E, C, D, o, F, w, y, U)=>{
            ...
            var M = MI(w);
            hA(M, function() {
                FA(`Cannot construct ${w} due to unbound types`, [
                    B
                ]);
            }), l([
                I,
                ...
                return Y = new oA(w, S, !0, !1, !1), v = new oA(w + "*", S, !1, !1, !1), K = new oA(w + " const*", S, !1, !0, !1), PA[I] = {
                    pointerType: v,
                    oa: K
                }, bA(M, N), [
                    Y,
        ...
        b: (I, A, g, B, Q, E, C, D, o)=>{
            ...
            A = h(A), A = _A(A), E = H(Q, E), l([], [
                ...
                var M = w.M.$, N = M[A];
                return N === void 0 || N.R === void 0 && N.className !== w.name && N.aa === g - 2 ? (y.aa = g - 2, y.className = w.name, M[A] = y) : (uA(M, A, U), M[A].R[g - 2] = y), l([], F, (Y)=>(Y = SA(U, Y, w, E, C, o), M[A].R === void 0 ? (Y.aa = g - 2, M[A] = Y) : M[A].R[g - 2] = Y, [])), [];
            });
        },
        z: (I)=>J(I, II),
        r: (I, A, g, B)=>{
        ...
        d: (I, A, g)=>{
            var B = gI(I, "enum");
            A = h(A), I = B.constructor, B = Object.create(B.constructor.prototype, {
                value: {
                    value: g
                },
                constructor: {
                    value: iA(`${B.name}_${A}`, function() {})
                }
            }), I.values[g] = B, I[A] = B;
        },
        m: (I, A, g)=>{
        ...
        l: (I, A, g, B, Q, E, C)=>{
            ...
            I = h(I), I = _A(I), Q = H(B, Q), hA(I, function() {
                FA(`Cannot call ${I} due to unbound types`, D);
                    ...
                    o[0],
                    null
                ].concat(o.slice(1)), bA(I, SA(I, o, null, Q, E, C), A - 1), []));
        },
        c: (I, A, g, B, Q)=>{
            A = h(A);
            let E = (D)=>D;
        ...
        f: (I, A, g)=>{
            if (g = h(g), A === 2) var B = rI, Q = nI, E = qI;
            else B = fI, Q = eI, E = dI;
            J(I, {
                name: g,
                N: (C)=>{
  ...
  ${D}
    ...
    function rA() {
        function I() {
            var g;
            if (i.calledRun = !0, !fA) {
                if (WA = !0, X.G(), AA == null || AA(i), (g = i.onRuntimeInitialized) == null || g.call(i), i.postRun) for(typeof i.postRun == "function" && (i.postRun = [
                    i.postRun
                ]); i.postRun.length;){
    ...
    if (i.preInit) for(typeof i.preInit == "function" && (i.preInit = [
        i.preInit
    ]); 0 < i.preInit.length;)i.preInit.shift()();
...
const T = (R, s, i = (L)=>L)=>{
    ...
    let k = null;
    try {
        if (k = i._malloc(Uint8Array.BYTES_PER_ELEMENT * L.length), k === null) throw new Error("couldn't allocate memory");
...
//# sourceMappingURL=node_modules_%40spz-loader_core_dist_index_52975555.js.map