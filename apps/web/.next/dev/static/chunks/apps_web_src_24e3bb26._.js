...
"[project]/apps/web/src/services/location/wofClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/services/location/wofIndex.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$location$2f$wofClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/services/location/wofClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$location$2f$wofIndex$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/services/location/wofIndex.ts [app-client] (ecmascript)");
;
;
;
;
...
async function resolveRegionsForCoordinate(countryIso, lat, lng) {
    ...
    const regions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$location$2f$wofIndex$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRegionsByCountryIso"])(countryIso);
...
async function fetchRegionGeoJson(id) {
    ...
    const geojson = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$location$2f$wofClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWofGeoJson"])(id);
...
function resolveCountry(station) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$location$2f$wofIndex$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCountryByIso"])(station.location.countryCode) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$location$2f$wofIndex$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findCountryByName"])(station.location.country) || null;
}
...
"[project]/apps/web/src/services/location/naturalEarthService.ts [app-client] (ecmascript)", (() => {{

throw new Error("An error occurred while generating the chunk item [project]/apps/web/src/services/location/naturalEarthService.ts [app-client] (ecmascript)\n\nCaused by:\n- the chunking context (unknown) does not support external modules (request: node:fs/promises)\n\nDebug info:\n- An error occurred while generating the chunk item [project]/apps/web/src/services/location/naturalEarthService.ts [app-client] (ecmascript)\n- Execution of <ModuleChunkItem as EcmascriptChunkItem>::content_with_async_module_info failed\n- Execution of *EcmascriptChunkItemContent::new failed\n- Execution of EcmascriptModuleContent::new failed\n- the chunking context (unknown) does not support external modules (request: node:fs/promises)");
   ...
   */ wrap(data, source) {
    ...
    async hydrateFromServerCache(force = false) {
        ...
        try {
            ...
            const fallback = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$location$2f$wofEnrichmentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enrichStationsWithWof"])(this.getFallbackStations());
...
//# sourceMappingURL=apps_web_src_24e3bb26._.js.map