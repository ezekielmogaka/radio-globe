...
class AudioService {
    ...
    handleError() {
        ...
        if (this.audio && this.audio.error && this.audio.error.code === MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED) {
            ...
            // Check if it's an HTTP stream on an HTTPS page (approximated, assuming we are on HTTPS or just upgrading anyway)
            if (currentSrc.startsWith('http://')) {
                ...
                // Only retry if we haven't already retried this specific upgrade or max retries reached
                // We use a separate flag or just check if retryCount is low. 
                // Since this is a specific upgrade, let's allow it if retryCount is 0, or just do it.
...
//# sourceMappingURL=apps_web_src_e0903e72._.js.map