   ...
   */ wrap(data, source) {
    ...
    async hydrateFromServerCache(force = false) {
        ...
        try {
            ...
            const stations = this.mapRadioBrowserStations(payload.stations || []);
            ...
            this.setCache("all", this.getFallbackStations(), "fallback");
        }
    }
...
//# sourceMappingURL=apps_web_src_08cf3356._.js.map