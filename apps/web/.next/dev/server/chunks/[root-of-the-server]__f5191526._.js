...
"[project]/apps/web/src/app/api/radio-browser/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        for(let i = 0; i < API_SERVERS.length; i++){
            ...
            try {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(data, {
                    headers: {
                ...
                console.warn(`[Radio Browser Proxy] Server ${baseUrl} failed:`, fetchError.message);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f5191526._.js.map