...
import { d as j } from "./chunk-ICY67TC6.js";
import { c as g } from "./chunk-G2EMNOST.js";
import { a as i } from "./chunk-4VFKVGYI.js";
import { b as n } from "./chunk-3WJNS2B6.js";
import { e as b } from "./chunk-XCN226AA.js";
function F(r, o, t) {
  return (
    t < 0 && (t += 1),
    t > 1 && (t -= 1),
...
e.fromCartesian4 = function (r, o) {
  return (
    n.typeOf.object("cartesian", r),
    b(o)
      ? ((o.red = r.x), (o.green = r.y), (o.blue = r.z), (o.alpha = r.w), o)
      : new e(r.x, r.y, r.z, r.w)
  );
};
e.fromBytes = function (r, o, t, f, C) {
  return (
    (r = e.byteToFloat(r ?? 255)),
    (o = e.byteToFloat(o ?? 255)),
    (t = e.byteToFloat(t ?? 255)),
    (f = e.byteToFloat(f ?? 255)),
    b(C)
      ? ((C.red = r), (C.green = o), (C.blue = t), (C.alpha = f), C)
      : new e(r, o, t, f)
  );
};
e.fromAlpha = function (r, o, t) {
  return (
    n.typeOf.object("color", r),
    n.typeOf.number("alpha", o),
    b(t)
      ? ((t.red = r.red),
        (t.green = r.green),
        (t.blue = r.blue),
        (t.alpha = o),
        t)
      : new e(r.red, r.green, r.blue, o)
  );
};
var l, A, E;
j.supportsTypedArrays() &&
  ((l = new ArrayBuffer(4)), (A = new Uint32Array(l)), (E = new Uint8Array(l)));
e.fromRgba = function (r, o) {
  return ((A[0] = r), e.fromBytes(E[0], E[1], E[2], E[3], o));
};
e.fromHsl = function (r, o, t, f, C) {
  ((r = (r ?? 0) % 1), (o = o ?? 0), (t = t ?? 0), (f = f ?? 1));
  let m = t,
    s = t,
    O = t;
  if (o !== 0) {
    let c;
    t < 0.5 ? (c = t * (1 + o)) : (c = t + o - t * o);
    let S = 2 * t - c;
    ((m = F(S, c, r + 1 / 3)), (s = F(S, c, r)), (O = F(S, c, r - 1 / 3)));
  }
  return b(C)
    ? ((C.red = m), (C.green = s), (C.blue = O), (C.alpha = f), C)
    : new e(m, s, O, f);
};
e.fromRandom = function (r, o) {
  r = r ?? g.EMPTY_OBJECT;
  let t = r.red;
  if (!b(t)) {
    let s = r.minimumRed ?? 0,
      O = r.maximumRed ?? 1;
    (n.typeOf.number.lessThanOrEquals("minimumRed", s, O),
      (t = s + i.nextRandomNumber() * (O - s)));
  }
  let f = r.green;
  if (!b(f)) {
    let s = r.minimumGreen ?? 0,
      O = r.maximumGreen ?? 1;
    (n.typeOf.number.lessThanOrEquals("minimumGreen", s, O),
      (f = s + i.nextRandomNumber() * (O - s)));
  }
  let C = r.blue;
  if (!b(C)) {
    let s = r.minimumBlue ?? 0,
      O = r.maximumBlue ?? 1;
    (n.typeOf.number.lessThanOrEquals("minimumBlue", s, O),
      (C = s + i.nextRandomNumber() * (O - s)));
  }
  let m = r.alpha;
  if (!b(m)) {
    let s = r.minimumAlpha ?? 0,
      O = r.maximumAlpha ?? 1;
    (n.typeOf.number.lessThanOrEquals("minimumAlpha", s, O),
      (m = s + i.nextRandomNumber() * (O - s)));
  }
  return b(o)
    ? ((o.red = t), (o.green = f), (o.blue = C), (o.alpha = m), o)
    : new e(t, f, C, m);
};
var a = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
  z = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/i,
  p =
    /^rgba?\s*\(\s*([0-9.]+%?)\s*[,\s]+\s*([0-9.]+%?)\s*[,\s]+\s*([0-9.]+%?)(?:\s*[,\s/]+\s*([0-9.]+))?\s*\)$/i,
  R =
    /^hsla?\s*\(\s*([0-9.]+)\s*[,\s]+\s*([0-9.]+%)\s*[,\s]+\s*([0-9.]+%)(?:\s*[,\s/]+\s*([0-9.]+))?\s*\)$/i;
e.fromCssColorString = function (r, o) {
  (n.typeOf.string("color", r), b(o) || (o = new e()), (r = r.trim()));
  let t = e[r.toUpperCase()];
  if (b(t)) return (e.clone(t, o), o);
  let f = a.exec(r);
  return f !== null
    ? ((o.red = parseInt(f[1], 16) / 15),
      (o.green = parseInt(f[2], 16) / 15),
      (o.blue = parseInt(f[3], 16) / 15),
      (o.alpha = parseInt(f[4] ?? "f", 16) / 15),
      o)
    : ((f = z.exec(r)),
      f !== null
        ? ((o.red = parseInt(f[1], 16) / 255),
          (o.green = parseInt(f[2], 16) / 255),
          (o.blue = parseInt(f[3], 16) / 255),
          (o.alpha = parseInt(f[4] ?? "ff", 16) / 255),
          o)
        : ((f = p.exec(r)),
          f !== null
            ? ((o.red =
...
e.packedLength = 4;
e.pack = function (r, o, t) {
  return (
    n.typeOf.object("value", r),
    n.defined("array", o),
    (t = t ?? 0),
    (o[t++] = r.red),
    (o[t++] = r.green),
...
e.byteToFloat = function (r) {
  return r / 255;
};
e.floatToByte = function (r) {
  return r === 1 ? 255 : (r * 256) | 0;
};
e.clone = function (r, o) {
  if (b(r))
    return b(o)
      ? ((o.red = r.red),
        (o.green = r.green),
        ...
        (o.alpha = r.alpha),
        o)
      : new e(r.red, r.green, r.blue, r.alpha);
};
e.equals = function (r, o) {
  return (
    r === o ||
    (b(r) &&
      b(o) &&
...
e.prototype.clone = function (r) {
  return e.clone(this, r);
};
e.prototype.equals = function (r) {
  return e.equals(this, r);
};
e.prototype.equalsEpsilon = function (r, o) {
  return (
    this === r ||
    (b(r) &&
      Math.abs(this.red - r.red) <= o &&
      Math.abs(this.green - r.green) <= o &&
      Math.abs(this.blue - r.blue) <= o &&
      Math.abs(this.alpha - r.alpha) <= o)
  );
};
...
e.prototype.toCssColorString = function () {
  let r = e.floatToByte(this.red),
    o = e.floatToByte(this.green),
    t = e.floatToByte(this.blue);
  return this.alpha === 1
    ? `rgb(${r},${o},${t})`
    : `rgba(${r},${o},${t},${this.alpha})`;
};
e.prototype.toCssHexString = function () {
  let r = e.floatToByte(this.red).toString(16);
  r.length < 2 && (r = `0${r}`);
  let o = e.floatToByte(this.green).toString(16);
  o.length < 2 && (o = `0${o}`);
  let t = e.floatToByte(this.blue).toString(16);
  if ((t.length < 2 && (t = `0${t}`), this.alpha < 1)) {
    let f = e.floatToByte(this.alpha).toString(16);
    return (f.length < 2 && (f = `0${f}`), `#${r}${o}${t}${f}`);
  }
  return `#${r}${o}${t}`;
};
e.prototype.toBytes = function (r) {
  let o = e.floatToByte(this.red),
    t = e.floatToByte(this.green),
    f = e.floatToByte(this.blue),
    C = e.floatToByte(this.alpha);
  return b(r)
    ? ((r[0] = o), (r[1] = t), (r[2] = f), (r[3] = C), r)
    : [o, t, f, C];
};
e.bytesToRgba = function (r, o, t, f) {
  return ((E[0] = r), (E[1] = o), (E[2] = t), (E[3] = f), A[0]);
};
e.prototype.toRgba = function () {
  return e.bytesToRgba(
    e.floatToByte(this.red),
    e.floatToByte(this.green),
    e.floatToByte(this.blue),
    e.floatToByte(this.alpha),
  );
};
e.prototype.brighten = function (r, o) {
  return (
    n.typeOf.number("magnitude", r),
    n.typeOf.number.greaterThanOrEquals("magnitude", r, 0),
    n.typeOf.object("result", o),
    (r = 1 - r),
    (o.red = 1 - (1 - this.red) * r),
    (o.green = 1 - (1 - this.green) * r),
    (o.blue = 1 - (1 - this.blue) * r),
    (o.alpha = this.alpha),
    o
  );
};
e.prototype.darken = function (r, o) {
  return (
    n.typeOf.number("magnitude", r),
    n.typeOf.number.greaterThanOrEquals("magnitude", r, 0),
    n.typeOf.object("result", o),
    (r = 1 - r),
    (o.red = this.red * r),
    (o.green = this.green * r),
    (o.blue = this.blue * r),
    (o.alpha = this.alpha),
    o
  );
};
e.prototype.withAlpha = function (r, o) {
  return e.fromAlpha(this, r, o);
};
e.add = function (r, o, t) {
  return (
    n.typeOf.object("left", r),
    n.typeOf.object("right", o),
    n.typeOf.object("result", t),
    (t.red = r.red + o.red),
    (t.green = r.green + o.green),
    (t.blue = r.blue + o.blue),
    (t.alpha = r.alpha + o.alpha),
    t
  );
};
e.subtract = function (r, o, t) {
  return (
    n.typeOf.object("left", r),
    n.typeOf.object("right", o),
    n.typeOf.object("result", t),
...
e.lerp = function (r, o, t, f) {
  return (
    n.typeOf.object("start", r),
    n.typeOf.object("end", o),
    n.typeOf.number("t", t),
    n.typeOf.object("result", f),
    (f.red = i.lerp(r.red, o.red, t)),
    (f.green = i.lerp(r.green, o.green, t)),
    (f.blue = i.lerp(r.blue, o.blue, t)),
    (f.alpha = i.lerp(r.alpha, o.alpha, t)),
    f
  );
};
e.multiplyByScalar = function (r, o, t) {
  return (
    n.typeOf.object("color", r),
    n.typeOf.number("scalar", o),
    n.typeOf.object("result", t),
    (t.red = r.red * o),
    (t.green = r.green * o),
    (t.blue = r.blue * o),
...
e.divideByScalar = function (r, o, t) {
  return (
    n.typeOf.object("color", r),
    n.typeOf.number("scalar", o),
    n.typeOf.object("result", t),
