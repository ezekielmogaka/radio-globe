...
import { a as P, c as B } from "./chunk-ICY67TC6.js";
import { a as y } from "./chunk-G2EMNOST.js";
import { a as L } from "./chunk-4VFKVGYI.js";
import { b as q } from "./chunk-3WJNS2B6.js";
...
function k(n, a, t, e, f, m, _) {
  let r = Y(n, t);
  return (1 - r) * n * a * (e + r * f * (_ + r * m * (2 * _ * _ - 1)));
}
function Z(n, a, t, e, f, m, _) {
  let r = (a - t) / a,
    p = m - e,
...
var $ = new y(),
  x = new y();
function N(n, a, t, e) {
  let f = y.normalize(e.cartographicToCartesian(a, x), $),
...
E.prototype.setEndPoints = function (n, a) {
  (q.defined("start", n), q.defined("end", a), N(this, n, a, this._ellipsoid));
};
...
E.prototype.interpolateUsingSurfaceDistance = function (n, a) {
  ...
  let C = Math.cos(2 * t.sigma + h),
    ...
    H =
      ...
      k(t.f, t.sineAlpha, t.cosineSquaredAlpha, h, d, g, C);
  return T(a)
