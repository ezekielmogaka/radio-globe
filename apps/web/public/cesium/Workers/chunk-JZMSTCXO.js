...
import { a as G } from "./chunk-YX3VGNCD.js";
import { a as z } from "./chunk-6L5NM26F.js";
import { b as B } from "./chunk-SPC72PTY.js";
import { a as C } from "./chunk-HVWI7BO6.js";
import { b as L } from "./chunk-5ELDAYCN.js";
import { a as D, c as I } from "./chunk-ICY67TC6.js";
import { a } from "./chunk-G2EMNOST.js";
import { a as S } from "./chunk-4VFKVGYI.js";
import { a as x } from "./chunk-3WJNS2B6.js";
...
function W(r, n, o, e, t, l, u, d) {
  let c = e.scaleToGeodeticSurface(r, k),
  ...
  (a.pack(s, u, i), (i += 3));
  for (let m = 1; m < h; m++) {
    let A = M.interpolateUsingSurfaceDistance(m * P, E);
    ((A.height = g[m]),
...
function $(r, n, o, e, t, l, u, d) {
  ...
  (a.pack(P, u, g), (g += 3));
  for (let i = 1; i < h; i++) {
    let s = R.interpolateUsingSurfaceDistance(i * y, E);
    ((s.height = f[i]),
  ...
  if (T(r) && r.length > 0) {
    ...
    for (let g = 1; g < y; ++g) {
      ...
      if (C.getPointDistance(w, f) < 0 || C.getPointDistance(w, P) < 0) {
        let i = B.lineSegmentPlane(f, P, d, J);
        if (T(i)) {
          let s = a.multiplyByScalar(u, 5e-9, K);
...
p.generateArc = function (r) {
  ...
  if (o < 1) return [];
  if (o === 1) {
    let i = e.scaleToGeodeticSurface(n[0], k);
    if (((t = l ? t[0] : t), t !== 0)) {
      let s = e.geodeticSurfaceNormal(i, b);
  ...
  let u = r.minDistance;
  if (!T(u)) {
    let i = r.granularity ?? S.RADIANS_PER_DEGREE;
  ...
  g.height = l ? t[o - 1] : t;
  let P = e.cartographicToCartesian(g, b);
...
p.generateRhumbArc = function (r) {
  ...
  if (o < 1) return [];
  if (o === 1) {
    let m = e.scaleToGeodeticSurface(n[0], k);
    if (((t = l ? t[0] : t), t !== 0)) {
      let A = e.geodeticSurfaceNormal(m, b);
  ...
  i.height = l ? t[o - 1] : t;
  let s = e.cartographicToCartesian(i, b);
