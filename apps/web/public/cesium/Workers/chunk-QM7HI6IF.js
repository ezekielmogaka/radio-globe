...
import { a as i } from "./chunk-G2EMNOST.js";
import { b as a } from "./chunk-3WJNS2B6.js";
import { e as c } from "./chunk-XCN226AA.js";
function t(m, n, e) {
  ((this.minimum = i.clone(m ?? i.ZERO)),
    (this.maximum = i.clone(n ?? i.ZERO)),
    c(e)
      ? (e = i.clone(e))
...
t.fromPoints = function (m, n) {
  ...
  return (
    ...
    (f.y = h),
    (f.z = l),
    (n.center = i.midpoint(x, f, n.center)),
    n
  );
};
...
t.intersectPlane = function (m, n) {
  (a.defined("box", m),
    a.defined("plane", n),
    (y = i.subtract(m.maximum, m.minimum, y)));
  let e = i.multiplyByScalar(y, 0.5, y),
    u = n.normal,
    o = e.x * Math.abs(u.x) + e.y * Math.abs(u.y) + e.z * Math.abs(u.z),
    r = i.dot(m.center, u) + n.distance;
  return r - o > 0 ? d.INSIDE : r + o < 0 ? d.OUTSIDE : d.INTERSECTING;
};
t.intersectAxisAlignedBoundingBox = function (m, n) {
  return (
    a.defined("box", m),
    a.defined("other", n),
    m.minimum.x <= n.maximum.x &&
      m.maximum.x >= n.minimum.x &&
      m.minimum.y <= n.maximum.y &&
      m.maximum.y >= n.minimum.y &&
      m.minimum.z <= n.maximum.z &&
      m.maximum.z >= n.minimum.z
  );
};
...
t.prototype.intersectAxisAlignedBoundingBox = function (m) {
  return t.intersectAxisAlignedBoundingBox(this, m);
};
