...
import { a as n, b as a } from "./chunk-3WJNS2B6.js";
import { c as E, d as I, e as o } from "./chunk-XCN226AA.js";
var d = E((_, m) => {
  var f = function (t) {
...
r.toSNorm = function (t, i) {
  return ((i = i ?? 255), Math.round((r.clamp(t, -1, 1) * 0.5 + 0.5) * i));
};
r.fromSNorm = function (t, i) {
  return ((i = i ?? 255), (r.clamp(t, 0, i) / i) * 2 - 1);
};
