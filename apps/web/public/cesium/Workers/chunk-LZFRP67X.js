...
import { a as Ua } from "./chunk-XGRCBY5T.js";
import { a as Mb, b as Pa, c as Fa } from "./chunk-33IJ66H2.js";
import { a as Ea } from "./chunk-VSMOUEKV.js";
import { a as ra } from "./chunk-AZKYNZOH.js";
import { a as rb } from "./chunk-DAX2P4DI.js";
import { a as Ha } from "./chunk-QM7HI6IF.js";
import { a as ib, b as gb } from "./chunk-SPC72PTY.js";
import { b as db, c as wa } from "./chunk-BNHFHP3L.js";
import {
  a as Ka,
  b as $b,
  d as hb,
  ...
  i as Ta,
  j as xa,
} from "./chunk-4NDD6KRQ.js";
import { b as P } from "./chunk-5ELDAYCN.js";
import { a as tb } from "./chunk-N6BI774S.js";
import { a as za } from "./chunk-6WLI3422.js";
import { a as V, b as K, c as Aa, d as nb } from "./chunk-ICY67TC6.js";
import { a as u, b as ya, c as fb } from "./chunk-G2EMNOST.js";
import { a as ba } from "./chunk-4VFKVGYI.js";
import { a as Ia, b as J } from "./chunk-3WJNS2B6.js";
import { d as Qb, e as _ } from "./chunk-XCN226AA.js";
var De = (function () {
  var c =
  ...
  var e,
    g = WebAssembly.instantiate(j(c), {}).then(function (k) {
      ((e = k.instance),
        e.exports.__wasm_call_ctors(),
        e.exports.meshopt_encodeVertexVersion(1),
        e.exports.meshopt_encodeIndexVersion(1));
    });
  function j(k) {
    for (var s = new Uint8Array(k.length), d = 0; d < k.length; ++d) {
      var n = k.charCodeAt(d);
      s[d] = n > 96 ? n - 97 : n > 64 ? n - 39 : n + 4;
    }
    for (var t = 0, d = 0; d < k.length; ++d)
      s[t++] = s[d] < 60 ? o[s[d]] : (s[d] - 60) * 64 + s[++d];
    return s.buffer.slice(0, t);
  }
  function b(k) {
  ...
  function E(k, s, d, n) {
    var t = e.exports.sbrk,
      a = t(s.length * 4),
      h = t(d * 4),
      f = new Uint8Array(e.exports.memory.buffer),
      i = r(s);
    (f.set(i, a), n && n(a, a, s.length, d));
    var l = k(h, a, s.length, d);
    f = new Uint8Array(e.exports.memory.buffer);
    var m = new Uint32Array(d);
    (new Uint8Array(m.buffer).set(f.subarray(h, h + d * 4)),
      i.set(f.subarray(a, a + s.length * 4)),
      t(a - t(0)));
    for (var p = 0; p < s.length; ++p) s[p] = m[s[p]];
    return [m, l];
  }
  function y(k, s, d, n) {
    var t = e.exports.sbrk,
    ...
    (f.set(r(s), h),
      k(a, h, d, n),
      (f = new Uint8Array(e.exports.memory.buffer)));
    var i = new Uint32Array(d);
    return (
      new Uint8Array(i.buffer).set(f.subarray(a, a + d * 4)),
      t(a - t(0)),
      i
    );
  }
  function F(k, s, d, n, t, a, h) {
    var f = e.exports.sbrk,
      i = f(s),
      l = f(n * t),
      m = new Uint8Array(e.exports.memory.buffer);
    m.set(r(d), l);
    var p = k(i, s, l, n, t, a, h),
      x = new Uint8Array(p);
    return (x.set(m.subarray(i, i + p)), f(i - f(0)), x);
  }
  function w(k) {
    for (var s = 0, d = 0; d < k.length; ++d) {
      var n = k[d];
      s = s < n ? n : s;
    }
    return s;
  ...
  function A(k, s) {
    if ((b(s == 2 || s == 4), s == 4))
      return new Uint32Array(k.buffer, k.byteOffset, k.byteLength / 4);
    var d = new Uint16Array(k.buffer, k.byteOffset, k.byteLength / 2);
    return new Uint32Array(d);
  }
  function O(k, s, d, n, t, a, h) {
    var f = e.exports.sbrk,
      i = f(d * n),
      l = f(d * a),
      m = new Uint8Array(e.exports.memory.buffer);
    (m.set(r(s), l), k(i, d, n, t, l, h));
    var p = new Uint8Array(d * n);
    return (p.set(m.subarray(i, i + d * n)), f(i - f(0)), p);
  }
  return {
    ready: g,
    supported: !0,
    reorderMesh: function (k, s, d) {
      var n = s
        ? d
          ? e.exports.meshopt_optimizeVertexCacheStrip
          : e.exports.meshopt_optimizeVertexCache
        : void 0;
      return E(e.exports.meshopt_optimizeVertexFetchRemap, k, w(k) + 1, n);
    },
    reorderPoints: function (k, s) {
      return (
        b(k instanceof Float32Array),
        b(k.length % s == 0),
        b(s >= 3),
        y(e.exports.meshopt_spatialSortRemap, k, k.length / s, s * 4)
      );
    },
    encodeVertexBuffer: function (k, s, d) {
      (b(d > 0 && d <= 256), b(d % 4 == 0));
      var n = e.exports.meshopt_encodeVertexBufferBound(s, d);
      return F(e.exports.meshopt_encodeVertexBuffer, n, k, s, d);
    },
    encodeVertexBufferLevel: function (k, s, d, n, t) {
      (b(d > 0 && d <= 256),
        b(d % 4 == 0),
        b(n >= 0 && n <= 3),
        b(t === void 0 || t == 0 || t == 1));
      var a = e.exports.meshopt_encodeVertexBufferBound(s, d);
      return F(
        e.exports.meshopt_encodeVertexBufferLevel,
        a,
        k,
        s,
        d,
    ...
    encodeIndexBuffer: function (k, s, d) {
      (b(d == 2 || d == 4), b(s % 3 == 0));
      var n = A(k, d),
        t = e.exports.meshopt_encodeIndexBufferBound(s, w(n) + 1);
      return F(e.exports.meshopt_encodeIndexBuffer, t, n, s, 4);
    },
    encodeIndexSequence: function (k, s, d) {
      b(d == 2 || d == 4);
      var n = A(k, d),
        t = e.exports.meshopt_encodeIndexSequenceBound(s, w(n) + 1);
      return F(e.exports.meshopt_encodeIndexSequence, t, n, s, 4);
    },
    encodeGltfBuffer: function (k, s, d, n, t) {
      var a = {
        ATTRIBUTES: this.encodeVertexBufferLevel,
        TRIANGLES: this.encodeIndexBuffer,
        INDICES: this.encodeIndexSequence,
      };
      return (b(a[n]), a[n](k, s, d, 2, t === void 0 ? 0 : t));
    },
    encodeFilterOct: function (k, s, d, n) {
      return (
        b(d == 4 || d == 8),
        b(n >= 2 && n <= 16),
        O(e.exports.meshopt_encodeFilterOct, k, s, d, n, 16)
      );
    },
    encodeFilterQuat: function (k, s, d, n) {
      return (
        b(d == 8),
        b(n >= 4 && n <= 16),
        O(e.exports.meshopt_encodeFilterQuat, k, s, d, n, 16)
      );
    },
    encodeFilterExp: function (k, s, d, n, t) {
      (b(d > 0 && d % 4 == 0), b(n >= 1 && n <= 24));
      var a = { Separate: 0, SharedVector: 1, SharedComponent: 2, Clamped: 3 };
      return O(e.exports.meshopt_encodeFilterExp, k, s, d, n, d, t ? a[t] : 1);
    },
    encodeFilterColor: function (k, s, d, n) {
      return (
        b(d == 4 || d == 8),
        b(n >= 2 && n <= 16),
        O(e.exports.meshopt_encodeFilterColor, k, s, d, n, 16)
      );
    },
  };
})();
var Ma = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var j = WebAssembly.validate(e) ? E(o) : E(c),
    b,
    r = WebAssembly.instantiate(j, {}).then(function (t) {
      ((b = t.instance), b.exports.__wasm_call_ctors());
    });
  function E(t) {
    for (var a = new Uint8Array(t.length), h = 0; h < t.length; ++h) {
      var f = t.charCodeAt(h);
      a[h] = f > 96 ? f - 97 : f > 64 ? f - 39 : f + 4;
    }
    for (var i = 0, h = 0; h < t.length; ++h)
      a[i++] = a[h] < 60 ? g[a[h]] : (a[h] - 60) * 64 + a[++h];
    return a.buffer.slice(0, i);
  }
  function y(t, a, h, f, i, l, m) {
    var p = t.exports.sbrk,
      x = (f + 3) & -4,
      N = p(x * i),
      v = p(l.length),
      I = new Uint8Array(t.exports.memory.buffer);
    I.set(l, v);
    var M = a(N, f, i, v, l.length);
    if (
      (M == 0 && m && m(N, x, i),
      h.set(I.subarray(N, N + f * i)),
      p(N - p(0)),
      M != 0)
    )
  ...
  var F = {
    ...
    O = 0;
  function k(t) {
    var a = { object: new Worker(t), pending: 0, requests: {} };
    return (
      (a.object.onmessage = function (h) {
        var f = h.data;
        ((a.pending -= f.count),
          a.requests[f.id][f.action](f.value),
          delete a.requests[f.id]);
      }),
      a
    );
  }
  function s(t) {
    for (
      var a =
          ...
          y.toString() +
          n.toString(),
        h = new Blob([a], { type: "text/javascript" }),
      ...
      A[i] = k(f);
    for (var i = t; i < A.length; ++i) A[i].object.postMessage({});
    ((A.length = t), URL.revokeObjectURL(f));
  }
  function d(t, a, h, f, i) {
    for (var l = A[0], m = 1; m < A.length; ++m)
      A[m].pending < l.pending && (l = A[m]);
    return new Promise(function (p, x) {
      var N = new Uint8Array(h),
        v = ++O;
      ((l.pending += t),
        (l.requests[v] = { resolve: p, reject: x }),
        l.object.postMessage(
          { id: v, count: t, size: a, source: N, mode: f, filter: i },
          [N.buffer],
        ));
    });
  }
  function n(t) {
    var a = t.data;
    if (!a.id) return self.close();
    self.ready.then(function (h) {
      try {
        var f = new Uint8Array(a.count * a.size);
        (y(
          h,
          h.exports[a.mode],
          f,
          ...
          self.postMessage(
            { id: a.id, count: a.count, action: "resolve", value: f },
            [f.buffer],
          ));
      } catch (i) {
        self.postMessage({
  ...
  return {
    ...
    decodeVertexBuffer: function (t, a, h, f, i) {
      y(b, b.exports.meshopt_decodeVertexBuffer, t, a, h, f, b.exports[F[i]]);
    },
    decodeIndexBuffer: function (t, a, h, f) {
      y(b, b.exports.meshopt_decodeIndexBuffer, t, a, h, f);
    },
    decodeIndexSequence: function (t, a, h, f) {
      y(b, b.exports.meshopt_decodeIndexSequence, t, a, h, f);
    },
    decodeGltfBuffer: function (t, a, h, f, i, l) {
      y(b, b.exports[w[i]], t, a, h, f, b.exports[F[l]]);
    },
    decodeGltfBufferAsync: function (t, a, h, f, i) {
      return A.length > 0
        ? d(t, a, h, w[f], F[i])
        : r.then(function () {
            var l = new Uint8Array(t * a);
            return (y(b, b.exports[w[f]], l, t, a, h, b.exports[F[i]]), l);
          });
    },
  };
})();
var Te = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var e,
    g = WebAssembly.instantiate(j(c), {}).then(function (a) {
      ((e = a.instance), e.exports.__wasm_call_ctors());
    });
  function j(a) {
    for (var h = new Uint8Array(a.length), f = 0; f < a.length; ++f) {
      var i = a.charCodeAt(f);
      h[f] = i > 96 ? i - 97 : i > 64 ? i - 39 : i + 4;
    }
    for (var l = 0, f = 0; f < a.length; ++f)
      h[l++] = h[f] < 60 ? o[h[f]] : (h[f] - 60) * 64 + h[++f];
    return h.buffer.slice(0, l);
  }
  function b(a) {
  ...
  function E(a, h, f, i) {
    var l = e.exports.sbrk,
      m = l(f * 4),
      p = l(f * i * 4),
      x = new Uint8Array(e.exports.memory.buffer);
    (x.set(r(h), p),
      a(m, p, f, i * 4),
      (x = new Uint8Array(e.exports.memory.buffer)));
    var N = new Uint32Array(f);
    return (
      new Uint8Array(N.buffer).set(x.subarray(m, m + f * 4)),
      l(m - l(0)),
      N
    );
  }
  function y(a, h, f) {
    var i = e.exports.sbrk,
      ...
      x = r(h);
    p.set(x, l);
    var N = a(m, l, h.length, f);
    p = new Uint8Array(e.exports.memory.buffer);
    var v = new Uint32Array(f);
    (new Uint8Array(v.buffer).set(p.subarray(m, m + f * 4)),
      x.set(p.subarray(l, l + h.length * 4)),
      i(l - i(0)));
    for (var I = 0; I < h.length; ++I) h[I] = v[h[I]];
    return [v, N];
  }
  function F(a) {
    for (var h = 0, f = 0; f < a.length; ++f) {
      var i = a[f];
      h = h < i ? i : h;
    }
    return h;
  }
  function w(a, h, f, i, l, m, p, x, N) {
    var v = e.exports.sbrk,
      I = v(4),
      M = v(f * 4),
      B = v(l * m),
      U = v(f * 4),
      D = new Uint8Array(e.exports.memory.buffer);
    (D.set(r(i), B), D.set(r(h), U));
    var z = a(M, U, f, B, l, m, p, x, N, I);
    D = new Uint8Array(e.exports.memory.buffer);
    var C = new Uint32Array(z);
    r(C).set(D.subarray(M, M + z * 4));
    var H = new Float32Array(1);
    return (r(H).set(D.subarray(I, I + 4)), v(I - v(0)), [C, H[0]]);
  }
  function A(a, h, f, i, l, m, p, x, N, v, I, M, B) {
    var U = e.exports.sbrk,
      D = U(4),
      z = U(f * 4),
      C = U(l * m),
      H = U(l * x),
    ...
    (L.set(r(i), C),
      ...
      L.set(r(h), W),
      v && L.set(r(v), X));
    var $ = a(z, W, f, C, l, m, H, x, T, N.length, X, I, M, B, D);
    L = new Uint8Array(e.exports.memory.buffer);
    var G = new Uint32Array($);
    r(G).set(L.subarray(z, z + $ * 4));
    var R = new Float32Array(1);
    return (r(R).set(L.subarray(D, D + 4)), U(D - U(0)), [G, R[0]]);
  }
  function O(a, h, f, i, l, m, p, x, N, v, I, M, B) {
    var U = e.exports.sbrk,
      D = U(4),
      z = U(l * m),
      C = U(l * x),
    ...
    (X.set(r(i), z),
      ...
      X.set(r(h), T),
      v && X.set(r(v), W));
    var L = a(T, f, z, l, m, C, x, H, N.length, W, I, M, B, D);
    ((X = new Uint8Array(e.exports.memory.buffer)),
      r(h).set(X.subarray(T, T + L * 4)),
      r(i).set(X.subarray(z, z + l * m)),
      r(p).set(X.subarray(C, C + l * x)));
    var $ = new Float32Array(1);
    return (r($).set(X.subarray(D, D + 4)), U(D - U(0)), [L, $[0]]);
  }
  function k(a, h, f, i) {
    var l = e.exports.sbrk,
      m = l(f * i),
  ...
  function s(a, h, f, i, l, m, p, x) {
    var N = e.exports.sbrk,
      v = N(x * 4),
      I = N(f * i),
      M = N(f * m),
      B = new Uint8Array(e.exports.memory.buffer);
    (B.set(r(h), I), l && B.set(r(l), M));
    var U = a(v, I, f, i, M, m, p, x);
    B = new Uint8Array(e.exports.memory.buffer);
    var D = new Uint32Array(U);
    return (r(D).set(B.subarray(v, v + U * 4)), N(v - N(0)), D);
  }
  function d(a, h, f, i, l, m, p, x, N) {
    var v = e.exports.sbrk,
      I = v(4),
      M = v(f * 4),
      B = v(l * m),
      U = v(f * 4),
      D = p ? v(l) : 0,
      z = new Uint8Array(e.exports.memory.buffer);
    (z.set(r(i), B), z.set(r(h), U), p && z.set(r(p), D));
    var C = a(M, U, f, B, l, m, D, x, N, I);
    z = new Uint8Array(e.exports.memory.buffer);
    var H = new Uint32Array(C);
    r(H).set(z.subarray(M, M + C * 4));
    var T = new Float32Array(1);
    return (r(T).set(z.subarray(I, I + 4)), v(I - v(0)), [H, T[0]]);
  }
  function n(a, h, f, i, l, m, p) {
    var x = e.exports.sbrk,
      N = x(f * 4),
      v = x(l * m),
      I = x(f * 4),
      M = new Uint8Array(e.exports.memory.buffer);
    (M.set(r(i), v), M.set(r(h), I));
    var B = a(N, I, f, v, l, m, p);
    M = new Uint8Array(e.exports.memory.buffer);
    var U = new Uint32Array(B);
    return (r(U).set(M.subarray(N, N + B * 4)), x(N - x(0)), U);
  }
  var t = {
    LockBorder: 1,
    Sparse: 2,
  ...
  return {
    ...
    compactMesh: function (a) {
      (b(
        ...
        b(a.length % 3 == 0));
      var h = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a);
      return y(e.exports.meshopt_optimizeVertexFetchRemap, h, F(a) + 1);
    },
    generatePositionRemap: function (a, h) {
      return (
        b(a instanceof Float32Array),
        b(a.length % h == 0),
        b(h >= 3),
        E(e.exports.meshopt_generatePositionRemap, a, a.length / h, h)
      );
    },
    simplify: function (a, h, f, i, l, m) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(a.length % 3 == 0),
        b(h instanceof Float32Array),
        b(h.length % f == 0),
        b(f >= 3),
        b(i >= 0 && i <= a.length),
        b(i % 3 == 0),
        b(l >= 0));
      for (var p = 0, x = 0; x < (m ? m.length : 0); ++x)
        (b(m[x] in t), (p |= t[m[x]]));
      var N = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        v = w(
          e.exports.meshopt_simplify,
          N,
          a.length,
          h,
          h.length / f,
      ...
      return (
        (v[0] = a instanceof Uint32Array ? v[0] : new a.constructor(v[0])),
        v
      );
    },
    simplifyWithAttributes: function (a, h, f, i, l, m, p, x, N, v) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(h.length % f == 0),
        b(f >= 3),
        b(i instanceof Float32Array),
        b(i.length == l * (h.length / f)),
        b(l >= 0),
        b(p == null || p instanceof Uint8Array),
        b(p == null || p.length == h.length / f),
        b(x >= 0 && x <= a.length),
        b(x % 3 == 0),
        b(N >= 0),
        b(Array.isArray(m)),
        b(l >= m.length),
        b(m.length <= 32));
      for (var I = 0; I < m.length; ++I) b(m[I] >= 0);
      for (var M = 0, I = 0; I < (v ? v.length : 0); ++I)
        (b(v[I] in t), (M |= t[v[I]]));
      var B = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        U = A(
          e.exports.meshopt_simplifyWithAttributes,
          B,
          a.length,
          h,
          h.length / f,
      ...
      return (
        (U[0] = a instanceof Uint32Array ? U[0] : new a.constructor(U[0])),
        U
      );
    },
    simplifyWithUpdate: function (a, h, f, i, l, m, p, x, N, v) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
      ...
      var B = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        U = O(
          e.exports.meshopt_simplifyWithUpdate,
          B,
          a.length,
          h,
          h.length / f,
      ...
      if (a !== B) for (var I = 0; I < U[0]; ++I) a[I] = B[I];
      return U;
    },
    getScale: function (a, h) {
      return (
        b(a instanceof Float32Array),
        b(a.length % h == 0),
        b(h >= 3),
        k(e.exports.meshopt_simplifyScale, a, a.length / h, h * 4)
      );
    },
    simplifyPoints: function (a, h, f, i, l, m) {
      return (
        b(a instanceof Float32Array),
        b(a.length % h == 0),
        b(h >= 3),
        ...
        i
          ? (b(i instanceof Float32Array),
            b(i.length % l == 0),
            b(l >= 3),
            b(a.length / h == i.length / l),
            s(
              e.exports.meshopt_simplifyPoints,
              a,
              a.length / h,
              h * 4,
              i,
    ...
    simplifySloppy: function (a, h, f, i, l, m) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(h.length % f == 0),
        b(f >= 3),
        b(i == null || i instanceof Uint8Array),
        b(i == null || i.length == h.length / f),
        b(l >= 0 && l <= a.length),
        b(l % 3 == 0),
        b(m >= 0));
      var p = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        x = d(
          e.exports.meshopt_simplifySloppy,
          p,
          a.length,
          h,
          h.length / f,
      ...
      return (
        (x[0] = a instanceof Uint32Array ? x[0] : new a.constructor(x[0])),
        x
      );
    },
    simplifyPrune: function (a, h, f, i) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(f >= 3),
        b(i >= 0));
      var l = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        m = n(
          e.exports.meshopt_simplifyPrune,
          l,
          a.length,
          h,
          h.length / f,
      ...
      return ((m = a instanceof Uint32Array ? m : new a.constructor(m)), m);
    },
  };
})();
var Pe = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var e,
    g = WebAssembly.instantiate(j(c), {}).then(function (d) {
      ((e = d.instance), e.exports.__wasm_call_ctors());
    });
  function j(d) {
    for (var n = new Uint8Array(d.length), t = 0; t < d.length; ++t) {
      var a = d.charCodeAt(t);
      n[t] = a > 96 ? a - 97 : a > 64 ? a - 39 : a + 4;
    }
    for (var h = 0, t = 0; t < d.length; ++t)
      n[h++] = n[t] < 60 ? o[n[t]] : (n[t] - 60) * 64 + n[++t];
    return n.buffer.slice(0, h);
  }
  function b(d) {
  ...
  var E = 48,
    y = 16;
  function F(d, n) {
    var t = d.meshlets[n * 4 + 0],
      a = d.meshlets[n * 4 + 1],
      h = d.meshlets[n * 4 + 2],
      f = d.meshlets[n * 4 + 3];
    return {
      vertices: d.vertices.subarray(t, t + h),
      triangles: d.triangles.subarray(a, a + f * 3),
    };
  }
  function w(d, n, t, a, h, f, i, l, m, p) {
    var x = e.exports.sbrk,
      N = e.exports.meshopt_buildMeshletsBound(n.length, f, i),
      v = x(N * y),
      I = x(n.length * 4),
      M = x(n.length),
      B = x(n.byteLength),
      U = x(t.byteLength),
      D = new Uint8Array(e.exports.memory.buffer);
    (D.set(r(n), B), D.set(r(t), U));
    var z = d(v, I, M, B, n.length, U, a, h, f, i, l, m, p);
    D = new Uint8Array(e.exports.memory.buffer);
    for (
      var C = D.subarray(v, v + z * y),
        H = new Uint32Array(C.buffer, C.byteOffset, C.byteLength / 4).slice(),
        T = 0;
      T < z;
      ++T
    ) {
      var W = H[T * 4 + 0],
        ...
        a = H[T * 4 + 2],
        L = H[T * 4 + 3];
      e.exports.meshopt_optimizeMeshlet(I + W * 4, M + X, L, a);
    }
    var $ = H[(z - 1) * 4 + 0],
      G = H[(z - 1) * 4 + 1],
      R = H[(z - 1) * 4 + 2],
      ...
      ca = {
        meshlets: H,
        vertices: new Uint32Array(D.buffer, I, Z).slice(),
        triangles: new Uint8Array(D.buffer, M, S * 3).slice(),
        meshletCount: z,
      };
    return (x(v - x(0)), ca);
  }
  function A(d) {
    var n = new Float32Array(e.exports.memory.buffer, d, E / 4);
    return {
      centerX: n[0],
      centerY: n[1],
      centerZ: n[2],
  ...
  function O(d, n, t, a) {
    var h = e.exports.sbrk,
      f = [],
      i = h(n.byteLength),
      l = h(d.vertices.byteLength),
      m = h(d.triangles.byteLength),
      p = h(E),
      x = new Uint8Array(e.exports.memory.buffer);
    (x.set(r(n), i), x.set(r(d.vertices), l), x.set(r(d.triangles), m));
    for (var N = 0; N < d.meshletCount; ++N) {
      var v = d.meshlets[N * 4 + 0],
        I = d.meshlets[N * 4 + 0 + 1],
        M = d.meshlets[N * 4 + 0 + 3];
      (e.exports.meshopt_computeMeshletBounds(p, l + v * 4, m + I, M, i, t, a),
        f.push(A(p)));
    }
    return (h(i - h(0)), f);
  }
  function k(d, n, t, a) {
    ...
    (m.set(r(d), i),
      m.set(r(n), l),
      e.exports.meshopt_computeClusterBounds(f, i, d.length, l, t, a));
    var p = A(f);
    return (h(f - h(0)), p);
  }
  function s(d, n, t, a, h) {
    var f = e.exports.sbrk,
      i = f(E),
      l = f(d.byteLength),
      m = a ? f(a.byteLength) : 0,
      p = new Uint8Array(e.exports.memory.buffer);
    (p.set(r(d), l),
      a && p.set(r(a), m),
      e.exports.meshopt_computeSphereBounds(i, l, n, t, m, a ? h : 0));
    var x = A(i);
    return (f(i - f(0)), x);
  }
  return {
    ready: g,
    supported: !0,
    buildMeshlets: function (d, n, t, a, h, f) {
      (b(d.length % 3 == 0),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3),
        b(a > 0 && a <= 256),
        b(h >= 1 && h <= 512),
        (f = f || 0));
      var i = d.BYTES_PER_ELEMENT == 4 ? d : new Uint32Array(d);
      return w(
        e.exports.meshopt_buildMeshletsFlex,
        i,
        n,
        n.length / t,
        t * 4,
    ...
    buildMeshletsFlex: function (d, n, t, a, h, f, i, l) {
      (b(d.length % 3 == 0),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3),
        ...
        (i = i || 0),
        (l = l || 0));
      var m = d.BYTES_PER_ELEMENT == 4 ? d : new Uint32Array(d);
      return w(
        e.exports.meshopt_buildMeshletsFlex,
        m,
        n,
    ...
    buildMeshletsSpatial: function (d, n, t, a, h, f, i) {
      (b(d.length % 3 == 0),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3),
        ...
        b(h <= f),
        (i = i || 0));
      var l = d.BYTES_PER_ELEMENT == 4 ? d : new Uint32Array(d);
      return w(
        e.exports.meshopt_buildMeshletsSpatial,
        l,
        n,
        n.length / t,
        t * 4,
    ...
    extractMeshlet: function (d, n) {
      return (b(n >= 0 && n < d.meshletCount), F(d, n));
    },
    computeClusterBounds: function (d, n, t) {
      (b(d.length % 3 == 0),
        b(d.length / 3 <= 512),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3));
      var a = d.BYTES_PER_ELEMENT == 4 ? d : new Uint32Array(d);
      return k(a, n, n.length / t, t * 4);
    },
    computeMeshletBounds: function (d, n, t) {
      return (
        b(d.meshletCount != 0),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3),
        O(d, n, n.length / t, t * 4)
      );
    },
    computeSphereBounds: function (d, n, t, a) {
      return (
        b(d instanceof Float32Array),
        b(d.length % n == 0),
        b(n >= 3),
        b(!t || t instanceof Float32Array),
        b(!t || t.length % a == 0),
        b(!t || a >= 1),
        b(!t || d.length / n == t.length / a),
        (a = a || 0),
        s(d, d.length / n, n * 4, t, a * 4)
      );
    },
  };
})();
var ka = { X: 0, Y: 1, Z: 2 };
ka.Y_UP_TO_Z_UP = P.fromRotationTranslation(
  ya.fromArray([1, 0, 0, 0, 0, 1, 0, -1, 0]),
);
ka.Z_UP_TO_Y_UP = P.fromRotationTranslation(
  ya.fromArray([1, 0, 0, 0, 0, -1, 0, 1, 0]),
);
ka.X_UP_TO_Z_UP = P.fromRotationTranslation(
  ya.fromArray([0, 0, 1, 0, 1, 0, -1, 0, 0]),
);
ka.Z_UP_TO_X_UP = P.fromRotationTranslation(
  ya.fromArray([0, 0, -1, 0, 1, 0, 1, 0, 0]),
);
ka.X_UP_TO_Y_UP = P.fromRotationTranslation(
  ya.fromArray([0, 1, 0, -1, 0, 0, 0, 0, 1]),
);
ka.Y_UP_TO_X_UP = P.fromRotationTranslation(
  ya.fromArray([0, -1, 0, 1, 0, 0, 0, 0, 1]),
);
ka.fromName = function (c) {
  return (J.typeOf.string("name", c), ka[c]);
};
var Ob = Object.freeze(ka);
var Va = { MORPHING: 0, COLUMBUS_VIEW: 1, SCENE2D: 2, SCENE3D: 3 };
Va.getMorphTime = function (c) {
  return c === Va.SCENE3D ? 1 : c === Va.MORPHING ? void 0 : 0;
};
var Ya = Object.freeze(Va);
var Db = Qb($b(), 1);
function _b() {
  return !0;
}
function ac(c, o) {
  o = o ?? "This object was destroyed, i.e., destroy() was called.";
  function e() {
    throw new Ia(o);
  }
  for (let g in c) typeof c[g] == "function" && (c[g] = e);
  c.isDestroyed = _b;
}
var Bb = ac;
function zb() {
  if (!_(Q._canTransferArrayBuffer)) {
    let c = mb("transferTypedArrayTest");
    c.postMessage = c.webkitPostMessage ?? c.postMessage;
    let o = 99,
      e = new Int8Array([o]);
    try {
      c.postMessage({ array: e }, [e.buffer]);
    } catch {
      return ((Q._canTransferArrayBuffer = !1), Q._canTransferArrayBuffer);
    }
    Q._canTransferArrayBuffer = new Promise((g) => {
      c.onmessage = function (j) {
        let b = j.data.array,
          r = _(b) && b[0] === o;
        (g(r), c.terminate(), (Q._canTransferArrayBuffer = r));
      };
    });
  }
  return Q._canTransferArrayBuffer;
}
var lb = new Fb();
function ob(c) {
  let o;
  try {
    o = new Blob([c], { type: "application/javascript" });
  } catch {
    let j =
        window.BlobBuilder ||
      ...
      b = new j();
    (b.append(c), (o = b.getBlob("application/javascript")));
  }
  return (window.URL || window.webkitURL).createObjectURL(o);
}
function mb(c) {
  let o = new Db.default(c),
    e = o.scheme().length !== 0 && o.fragment().length === 0,
    g = c.replace(/\.js$/, ""),
    j = {},
    b,
    r;
  if (hb(c)) r = c;
    ...
    let E = Na(`${Q._workerModulePrefix}/${g}.js`);
    hb(E) && (r = E);
  }
  if (r) {
    let E = `import "${r}";`;
    return ((b = ob(E)), (j.type = "module"), new Worker(b, j));
  }
  if (!e && typeof CESIUM_WORKERS < "u") {
    let E = `
      importScripts("${ob(CESIUM_WORKERS)}");
      CesiumWorkers["${g}"]();
    `;
    return ((b = ob(E)), new Worker(b, j));
  }
  if (
    ((b = c),
    e || (b = Na(`${Q._workerModulePrefix + g}.js`)),
    !nb.supportsEsmWebWorkers())
  )
    throw new za(
      "This browser is not supported. Please update your browser to continue.",
    );
  return ((j.type = "module"), new Worker(b, j));
}
async function bc(c, o) {
  let e = { modulePath: void 0, wasmBinaryFile: void 0, wasmBinary: void 0 };
  if (!nb.supportsWebAssembly()) {
    if (!_(o.fallbackModulePath))
      throw new za(
        `This browser does not support Web Assembly, and no backup module was provided for ${c._workerPath}`,
      );
    return ((e.modulePath = Na(o.fallbackModulePath)), e);
  }
  e.wasmBinaryFile = Na(o.wasmBinaryFile);
  let g = await Ub.fetchArrayBuffer({ url: e.wasmBinaryFile });
  return ((e.wasmBinary = g), e);
}
function Q(c, o) {
  ((this._workerPath = c),
    (this._maximumActiveTasks = o ?? Number.POSITIVE_INFINITY),
    (this._activeTasks = 0),
    (this._nextID = 0),
    ...
    let j = ({ data: b }) => {
      if (b.id === o) {
        if (_(b.error)) {
          let r = b.error;
          (r.name === "RuntimeError"
            ? ((r = new za(b.error.message)), (r.stack = b.error.stack))
            : r.name === "DeveloperError"
              ? ((r = new Ia(b.error.message)), (r.stack = b.error.stack))
              : r.name === "Error" &&
                ((r = new Error(b.error.message)), (r.stack = b.error.stack)),
            lb.raiseEvent(r),
            g(r));
        } else (lb.raiseEvent(), e(b.result));
        c.removeEventListener("message", j);
      }
    };
    return j;
  },
  ec = [];
async function dc(c, o, e) {
  let g = await Promise.resolve(zb());
  _(e) ? g || (e.length = 0) : (e = ec);
  let j = c._nextID++,
    b = new Promise((r, E) => {
      c._worker.addEventListener("message", cc(c._worker, j, r, E));
    });
  return (
    c._worker.postMessage(
      {
        id: j,
        baseUrl: Na.getCesiumBaseUrl().url,
        parameters: o,
        canTransferArrayBuffer: g,
      },
      e,
    ),
    b
...
async function fc(c, o, e) {
  ++c._activeTasks;
  try {
    let g = await dc(c, o, e);
    return (--c._activeTasks, g);
  } catch (g) {
    throw (--c._activeTasks, g);
  }
}
Q.prototype.scheduleTask = function (c, o) {
  if (
    (_(this._worker) || (this._worker = mb(this._workerPath)),
    !(this._activeTasks >= this._maximumActiveTasks))
  )
    return fc(this, c, o);
};
Q.prototype.initWebAssemblyModule = async function (c) {
  if (_(this._webAssemblyPromise)) return this._webAssemblyPromise;
  let o = async () => {
    let e = (this._worker = mb(this._workerPath)),
      g = await bc(this, c),
      j = await Promise.resolve(zb()),
      b,
      r = g.wasmBinary;
    _(r) && j && (b = [r]);
    let E = new Promise((y, F) => {
      e.onmessage = function ({ data: w }) {
        _(w) ? y(w.result) : F(new za("Could not configure wasm module"));
      };
    });
    return (
      e.postMessage(
        { canTransferArrayBuffer: j, parameters: { webAssemblyConfig: g } },
        b,
      ),
      E
    );
  };
  return ((this._webAssemblyPromise = o()), this._webAssemblyPromise);
};
Q.prototype.isDestroyed = function () {
  return !1;
};
Q.prototype.destroy = function () {
  return (_(this._worker) && this._worker.terminate(), Bb(this));
};
Q.taskCompletedEvent = lb;
Q._defaultWorkerModulePrefix = "Workers/";
Q._workerModulePrefix = Q._defaultWorkerModulePrefix;
Q._canTransferArrayBuffer = void 0;
var Kb = Q;
var hc = 3;
function kb(c, o, e) {
  (J.defined("vertices", c),
    J.defined("indices", o),
    J.defined("encoding", e),
    (this._vertices = c),
    (this._indices = o),
    (this._encoding = e),
    (this._inverseTransform = new P()),
    (this._needsRebuild = !0),
    (this._rootNode = new jb()));
}
var nc = new Kb("incrementallyBuildTerrainPicker");
...
function jb() {
  ((this.x = 0),
    (this.y = 0),
    (this.level = 0),
    (this.aabb = Tb(this.x, this.y, this.level)),
    (this.intersectingTriangles = new Uint32Array(0)),
    (this.children = []),
    (this.buildingChildren = !1));
}
jb.prototype.addChild = function (c) {
  if (c < 0 || c > 3)
    throw new Ia(
  ...
  ((o.x = this.x * 2 + (c & 1)),
    ...
    (o.aabb = Tb(o.x, o.y, o.level)),
    (this.children[c] = o));
};
var tc = new ib(),
  Za = [new u(), new u(), new u()];
kb.prototype.rayIntersect = function (c, o, e, g, j) {
  this._needsRebuild && rc(this, o);
  let b = this._inverseTransform,
    r = tc;
  ((r.origin = P.multiplyByPoint(b, c.origin, r.origin)),
    (r.direction = P.multiplyByPointAsVector(b, c.direction, r.direction)));
  let E = [];
  return (Hb(this._rootNode, r, E), mc(this, E, c, e, g, j));
};
function rc(c, o) {
  (P.inverse(o, c._inverseTransform), (c._needsRebuild = !1));
  let e = c._indices.length / 3,
    g = new Uint32Array(e);
  for (let j = 0; j < e; ++j) g[j] = j;
  ((c._rootNode.intersectingTriangles = g), (c._rootNode.children.length = 0));
}
var ic = new u(),
  gc = new u();
function Tb(c, o, e) {
  let g = 1 / Math.pow(2, e),
    j = u.fromElements(c * g - 0.5, o * g - 0.5, -0.5, ic),
    b = u.fromElements((c + 1) * g - 0.5, (o + 1) * g - 0.5, 0.5, gc);
  return Ha.fromCorners(j, b);
}
function oc(c, o, e, g, j) {
  (u.pack(e[0], c, 9 * j),
    u.pack(e[1], c, 9 * j + 3),
    u.pack(e[2], c, 9 * j + 6),
    (o[j] = g));
...
var lc = new db();
function Hb(c, o, e) {
  let g = gb.rayAxisAlignedBoundingBox(o, c.aabb, lc);
  if (!_(g)) return;
  if (!c.children.length || c.buildingChildren) {
    e.push({ node: c, interval: new db(g.start, g.stop) });
    return;
  }
  for (let b = 0; b < c.children.length; b++) Hb(c.children[b], o, e);
}
function mc(c, o, e, g, j, b) {
  let r = o.sort(function (y, F) {
      return y.interval.start - F.interval.start;
    }),
    E = Number.MAX_VALUE;
  for (let y = 0; y < r.length; y++) {
    let F = r[y],
      w = sc(c, e, F.node, g, j, b);
    if (((E = Math.min(w, E)), E !== Number.MAX_VALUE)) break;
  }
  if (E !== Number.MAX_VALUE) return ib.getPoint(e, E);
}
function sc(c, o, e, g, j, b) {
  let r = Number.MAX_VALUE,
    E = c._encoding,
    y = c._indices,
    F = c._vertices,
    w = e.intersectingTriangles.length,
    O = !(e.level >= hc) && !e.buildingChildren,
    k,
    s;
  O && ((k = new Float32Array(w * 9)), (s = new Uint32Array(w)));
  for (let d = 0; d < w; d++) {
    let n = e.intersectingTriangles[d],
      t = sb(E, j, b, F, y[3 * n], Za[0]),
      a = sb(E, j, b, F, y[3 * n + 1], Za[1]),
      h = sb(E, j, b, F, y[3 * n + 2], Za[2]),
      f = gb.rayTriangleParametric(o, t, a, h, g);
    (_(f) && f < r && f >= 0 && (r = f), O && oc(k, s, Za, n, d));
  }
  if (O) {
    for (let d = 0; d < 4; d++) e.addChild(d);
    kc(c._inverseTransform, e, s, k);
  }
  return r;
}
var jc = new V();
function sb(c, o, e, g, j, b) {
  let r = c.getExaggeratedPosition(g, j, b);
  if (o === Ya.SCENE3D) return r;
  let y = e.ellipsoid.cartesianToCartographic(r, jc);
  return ((r = e.project(y, b)), (r = u.fromElements(r.z, r.x, r.y, b)), r);
}
async function kc(c, o, e, g) {
  o.buildingChildren = !0;
  let j = new Float64Array(16);
  P.pack(c, j, 0);
  let b = new Float64Array(24);
  for (let w = 0; w < 4; w++)
    (u.pack(o.children[w].aabb.minimum, b, w * 6),
      u.pack(o.children[w].aabb.maximum, b, w * 6 + 3));
  let r = {
      aabbs: b,
      inverseTransform: j,
      triangleIndices: e,
    ...
    E = [b.buffer, j.buffer, e.buffer, g.buffer],
    y = nc.scheduleTask(r, E);
  if (!_(y)) {
    o.buildingChildren = !1;
    return;
  }
  ((await y).intersectingTrianglesArrays.forEach((w, A) => {
    o.children[A].intersectingTriangles = new Uint32Array(w);
  }),
    (o.intersectingTriangles = new Uint32Array(0)),
    (o.buildingChildren = !1));
}
var Pb = kb;
function qa(c, o, e, g, j, b, r, E, y, F, w, A, O, k, s, d, n) {
  ((this.center = c),
    (this.vertices = o),
    (this.stride = w ?? 6),
    (this.indices = e),
    (this.indexCountWithoutSkirts = g),
    (this.vertexCountWithoutSkirts = j),
    (this.minimumHeight = b),
    (this.maximumHeight = r),
    (this.rectangle = E),
    (this.boundingSphere3D = y),
    (this.occludeePointInScaledSpace = F),
    (this.orientedBoundingBox = A),
    (this.encoding = O),
    (this.westIndicesSouthToNorth = k),
    (this.southIndicesEastToWest = s),
    (this.eastIndicesNorthToSouth = d),
    (this.northIndicesWestToEast = n),
    (this._transform = new P()),
    (this._recomputeTransform = !0),
    (this._terrainPicker = new Pb(o, e, O)));
}
qa.prototype.getTransform = function (c, o) {
  return this._recomputeTransform
    ? ((this._recomputeTransform = !1),
      !_(c) || c === Ya.SCENE3D
        ? uc(this, this._transform)
        : Ic(this, o, this._transform))
    : this._transform;
};
function uc(c, o) {
  let e = c.encoding.exaggeration,
    g = c.encoding.exaggerationRelativeHeight,
    j = Pa.getHeight(c.minimumHeight, e, g),
    b = Pa.getHeight(c.maximumHeight, e, g),
    r = ra.fromRectangle(c.rectangle, j, b, Aa.default, c.orientedBoundingBox);
  return ra.computeTransformation(r, o);
}
var pc = new u(),
  wc = new u(),
  yc = new V(),
  ...
  vc = new u();
function Ic(c, o, e) {
  let g = c.encoding.exaggeration,
    j = c.encoding.exaggerationRelativeHeight,
    b = Pa.getHeight(c.minimumHeight, g, j),
    r = Pa.getHeight(c.maximumHeight, g, j),
    E = o.project(
      V.fromRadians(c.rectangle.west, c.rectangle.south, 0, yc),
      pc,
    ),
    y = o.project(
      V.fromRadians(c.rectangle.east, c.rectangle.north, 0, xc),
      wc,
    ),
    F = r - b,
    w = u.fromElements(y.x - E.x, y.y - E.y, F > 0 ? F : 1, Ec),
    A = u.fromElements(E.x + w.x * 0.5, E.y + w.y * 0.5, b + w.z * 0.5, vc);
  return (
    P.fromTranslation(A, e),
    P.setScale(e, w, e),
    P.multiply(Ta.SWIZZLE_3D_TO_2D_MATRIX, e, e),
    e
  );
}
qa.prototype.pick = function (c, o, e, g) {
  return this._terrainPicker.rayIntersect(c, this.getTransform(e, g), o, e, g);
};
qa.prototype.updateExaggeration = function (c, o) {
  ((this._terrainPicker._vertices = this.vertices),
    (this._terrainPicker.needsRebuild = !0),
    (this._recomputeTransform = !0));
};
qa.prototype.updateSceneMode = function (c) {
  ((this._terrainPicker.needsRebuild = !0), (this._recomputeTransform = !0));
};
var ub = qa;
var pb = {},
  Ac = {
...
pb.createMesh = async function (c) {
  c = c ?? fb.EMPTY_OBJECT;
  let {
    exaggeration: o = 1,
    exaggerationRelativeHeight: e = 0,
    hasVertexNormals: g,
    hasWebMercatorT: j,
    gltf: b,
    minimumHeight: r,
  ...
  (J.typeOf.object("options.ellipsoid", c.ellipsoid),
    J.typeOf.object("options.rectangle", c.rectangle),
    J.typeOf.bool("options.hasVertexNormals", g),
    J.typeOf.bool("options.hasWebMercatorT", j),
    J.typeOf.object("options.gltf", b),
    J.typeOf.number("options.minimumHeight", r),
    J.typeOf.number("options.maximumHeight", E),
    J.typeOf.object("options.boundingSphere", c.boundingSphere),
    J.typeOf.object("options.orientedBoundingBox", c.orientedBoundingBox),
    J.typeOf.object("options.horizonOcclusionPoint", c.horizonOcclusionPoint),
    J.typeOf.number("options.skirtHeight", y));
  let w = o !== 1,
    A = wa.clone(c.boundingSphere, new wa()),
    O = ra.clone(c.orientedBoundingBox, new ra()),
    k = u.clone(c.horizonOcclusionPoint, new u()),
    s = Aa.clone(c.ellipsoid, new Aa()),
    d = xa.clone(c.rectangle, new xa());
  await (b.extensionsRequired !== void 0 &&
  b.extensionsRequired.indexOf("EXT_meshopt_compression") !== -1
    ? Ma.ready
  ...
  let a = d.west,
    ...
    m = xa.center(d, Nc);
  m.height = 0.5 * (r + E);
  let p = V.toCartesian(m, s, Fc),
    x = Ta.eastNorthUpToFixedFrame(p, s, Uc),
    N = P.inverseTransformation(x, Mc),
    v = P.unpack(b.nodes[0].matrix, 0, Oc);
  v = P.multiply(Ob.Y_UP_TO_Z_UP, v, v);
  let I = pe(b, g, Ac),
    M = Ua.getSkirtVertexCount(
      I.edgeIndicesWest,
      I.edgeIndicesSouth,
      I.edgeIndicesEast,
      I.edgeIndicesNorth,
    ...
    C = z + M,
    H = D.length,
    T = Ua.getSkirtIndexCountWithFilledCorners(M),
    W = C <= 65535 ? Uint16Array : Uint32Array,
    X = new W(H + T);
  X.set(D);
  let L = new W(I.edgeIndicesWest),
    $ = new W(I.edgeIndicesSouth),
    G = new W(I.edgeIndicesEast),
    R = new W(I.edgeIndicesNorth),
    q = new W(L).sort(),
    Z = new W($).sort(),
    S = new W(G).sort(),
    ca = new W(R).sort(),
    aa = Ea.geodeticLatitudeToMercatorAngle(h),
    ia = 1 / (Ea.geodeticLatitudeToMercatorAngle(f) - aa),
    ga = u.fromElements(
    ...
    la = new Fa(A.center, void 0, void 0, void 0, void 0, g, j, w, o, e),
    oa = la.stride,
    ea = new Float32Array(C * oa),
    da = 0;
  for (let Y = 0; Y < z; Y++) {
    let va = u.unpack(B, Y * 3, zc),
      ma = P.multiplyByPoint(v, va, Kc),
      Ca = V.fromCartesian(ma, s, Tc),
      { longitude: _a, latitude: Oa, height: sa } = Ca,
      ja = (_a - a) / i,
      ua = (Oa - h) / l;
    ((ja = ba.clamp(ja, 0, 1)),
      (ua = ba.clamp(ua, 0, 1)),
      Ka(q, Y, Qa) >= 0 ? (ja = 0) : Ka(S, Y, Qa) >= 0 && (ja = 1),
      Ka(Z, Y, Qa) >= 0 ? (ua = 0) : Ka(ca, Y, Qa) >= 0 && (ua = 1));
    let Wa = K.fromElements(ja, ua, Hc),
      Ba;
    if (g) {
      let na = u.unpack(U, Y * 3, Ja);
      ((na = P.multiplyByPointAsVector(v, na, Ja)),
        (na = u.normalize(na, Ja)),
        (Ba = rb.octEncode(na, Pc)));
    }
    let pa;
    j && (pa = (Ea.geodeticLatitudeToMercatorAngle(Oa) - aa) * ia);
    let Ra;
    (w && (Ra = s.geodeticSurfaceNormal(ma, qc)),
      (da = la.encode(ea, da, ma, Wa, sa, Ba, pa, Ra)));
    let Xa = P.multiplyByPoint(N, ma, Jc);
    ((ga = u.minimumByComponent(Xa, ga, ga)),
      (ha = u.maximumByComponent(Xa, ha, ha)));
  }
  let fa = new ub(
    u.clone(la.center, new u()),
    ea,
    X,
    H,
    z,
  ...
  return (Sb(fa, d, s, ga, ha, x, N, y), Promise.resolve(fa));
};
var Cc = new K(),
  Wc = new K(),
  Rc = new Array(6),
  ...
  se = new u();
function je(c) {
  let o = c.meshes[0].primitives[0],
    e = c.accessors[o.attributes.POSITION],
    g = c.bufferViews[e.bufferView],
    j = e.count,
    b = g.extensions ? g.extensions.EXT_meshopt_compression : void 0;
  if (b === void 0) {
    let k = c.buffers[g.buffer].extras._pipeline.source;
    return new Float32Array(
      k.buffer,
      k.byteOffset + (g.byteOffset ?? 0) + (e.byteOffset ?? 0),
      j * 3,
    );
  }
  let r = c.buffers[b.buffer].extras._pipeline.source,
    E = new Uint8Array(
      r.buffer,
      r.byteOffset + (b.byteOffset ?? 0) + (e.byteOffset ?? 0),
      b.byteLength,
    ),
    y = b.byteStride,
    F = y === 4 ? Uint8Array : Uint16Array,
    w = new F(j * 4);
  Ma.decodeVertexBuffer(new Uint8Array(w.buffer), j, y, E);
  let A = (1 << (w.BYTES_PER_ELEMENT * 8)) - 1,
...
function ke(c) {
  let o = c.meshes[0].primitives[0],
    e = c.accessors[o.attributes.NORMAL],
    g = c.bufferViews[e.bufferView],
    j = e.count,
    b = g.extensions ? g.extensions.EXT_meshopt_compression : void 0;
  if (b === void 0) {
    let A = c.buffers[g.buffer].extras._pipeline.source;
    return new Float32Array(
      A.buffer,
      A.byteOffset + (g.byteOffset ?? 0) + (e.byteOffset ?? 0),
      j * 3,
    );
  }
  let r = c.buffers[b.buffer].extras._pipeline.source,
    ...
    y = b.byteStride,
    F = new Int8Array(j * y);
  Ma.decodeVertexBuffer(new Uint8Array(F.buffer), j, y, E);
  let w = new Float32Array(j * 3);
  for (let A = 0; A < j; A++) {
    let O = Math.max(F[A * 4 + 0] / 127, -1),
      k = Math.max(F[A * 4 + 1] / 127, -1),
      s = 1 - (Math.abs(O) + Math.abs(k));
    if (s < 0) {
      let n = O,
        t = k;
      ((O = (1 - Math.abs(t)) * ba.signNotZero(n)),
        (k = (1 - Math.abs(n)) * ba.signNotZero(t)));
    }
    let d = Ja;
    ((d.x = O),
      (d.y = k),
...
function ue(c) {
  let o = c.meshes[0].primitives[0],
    e = c.accessors[o.indices],
    g = c.bufferViews[e.bufferView],
    j = e.count,
    b = e.componentType === tb.UNSIGNED_SHORT ? Uint16Array : Uint32Array,
    r = g.extensions ? g.extensions.EXT_meshopt_compression : void 0;
  if (r === void 0) {
    let w = c.buffers[g.buffer].extras._pipeline.source;
    return new b(
      w.buffer,
      w.byteOffset + (g.byteOffset ?? 0) + (e.byteOffset ?? 0),
      j,
    );
  }
  let E = c.buffers[r.buffer].extras._pipeline.source,
    y = new Uint8Array(
      E.buffer,
      E.byteOffset + (r.byteOffset ?? 0) + (e.byteOffset ?? 0),
      r.byteLength,
    ),
    F = new b(j);
  return (
    Ma.decodeIndexBuffer(new Uint8Array(F.buffer), j, r.byteStride, y),
    F
  );
}
function $a(c, o) {
  let e = c.meshes[0].primitives[0],
    g = c.accessors[e.extensions.CESIUM_tile_edges[o]],
    j = c.bufferViews[g.bufferView],
    b = g.count,
    r = g.componentType === tb.UNSIGNED_SHORT ? Uint16Array : Uint32Array,
    E = j.extensions ? j.extensions.EXT_meshopt_compression : void 0;
  if (E === void 0) {
    let O = c.buffers[j.buffer].extras._pipeline.source;
    return new r(
      O.buffer,
      O.byteOffset + (j.byteOffset ?? 0) + (g.byteOffset ?? 0),
      b,
    );
  }
  let y = c.buffers[E.buffer].extras._pipeline.source,
    F = new Uint8Array(
      y.buffer,
      y.byteOffset + (E.byteOffset ?? 0) + (g.byteOffset ?? 0),
      E.byteLength,
    ),
    w = new r(b),
    A = E.byteStride;
  return (Ma.decodeIndexSequence(new Uint8Array(w.buffer), b, A, F), w);
}
function pe(c, o, e) {
  return (
    (e.positions = je(c)),
    (e.normals = o ? ke(c) : void 0),
    (e.indices = ue(c)),
    (e.edgeIndicesWest = $a(c, "left")),
    (e.edgeIndicesSouth = $a(c, "bottom")),
    (e.edgeIndicesEast = $a(c, "right")),
    (e.edgeIndicesNorth = $a(c, "top")),
    e
  );
}
pb.upsampleMesh = function (c) {
  c = c ?? fb.EMPTY_OBJECT;
  let {
    isEastChild: o,
    isNorthChild: e,
    parentMinimumHeight: g,
    parentMaximumHeight: j,
    skirtHeight: b,
  } = c;
  (J.typeOf.bool("options.isEastChild", o),
    J.typeOf.bool("options.isNorthChild", e),
    J.typeOf.object("options.parentVertices", c.parentVertices),
    J.typeOf.object("options.parentIndices", c.parentIndices),
    J.typeOf.number(
      "options.parentVertexCountWithoutSkirts",
      c.parentVertexCountWithoutSkirts,
    ),
    J.typeOf.number(
      "options.parentIndexCountWithoutSkirts",
      c.parentIndexCountWithoutSkirts,
    ),
    J.typeOf.number("options.parentMinimumHeight", g),
    J.typeOf.number("options.parentMaximumHeight", j),
    J.typeOf.object("options.parentEncoding", c.parentEncoding),
    J.typeOf.object("options.rectangle", c.rectangle),
    J.typeOf.number("options.skirtHeight", b),
    J.typeOf.object("options.ellipsoid", c.ellipsoid));
  let r = c.parentIndexCountWithoutSkirts,
    E = c.parentIndices,
    y = c.parentVertexCountWithoutSkirts,
    F = c.parentVertices,
    w = Fa.clone(c.parentEncoding, new Fa()),
    A = w.hasVertexNormals,
    O = w.hasWebMercatorT,
    k = w.exaggeration,
    s = w.exaggerationRelativeHeight,
    n = k !== 1,
    t = xa.clone(c.rectangle, new xa()),
    a = Aa.clone(c.ellipsoid),
    h = [],
    f = [],
    i = [],
    l = [],
    ...
    x = [],
    N = [];
  Be(o, e, r, E, y, F, w, l, m, p, x, N, h, i, f);
  let v = xa.center(t, Zc);
  v.height = 0.5 * (g + j);
  let I = V.toCartesian(v, a, Qc),
    M = h.length,
    B = new Fa(I, void 0, void 0, void 0, void 0, A, O, n, k, s),
    U = B.stride,
    D = Ua.getSkirtVertexCount(m, p, x, N),
    z = M + D,
    C = l.length,
    H = Ua.getSkirtIndexCountWithFilledCorners(D),
    T = C + H,
    W = z <= 65535 ? Uint16Array : Uint32Array,
    X = new W(T);
  X.set(l);
  let L = new W(m),
    $ = new W(p),
    G = new W(x),
    R = new W(N),
    q = new Float32Array(z * U),
    Z = 0,
    S = Ta.eastNorthUpToFixedFrame(I, a, ne),
    ca = P.inverseTransformation(S, te),
    aa = t.west,
    ta = t.east,
    ia = t.south,
    ga = t.north,
    ha = Ea.geodeticLatitudeToMercatorAngle(ia),
    oa = 1 / (Ea.geodeticLatitudeToMercatorAngle(ga) - ha),
    ea = Number.POSITIVE_INFINITY,
    da = Number.NEGATIVE_INFINITY,
    fa = u.fromElements(
      Number.POSITIVE_INFINITY,
      Number.POSITIVE_INFINITY,
      Number.POSITIVE_INFINITY,
  ...
  for (let sa = 0; sa < M; sa++) {
    let ja = h[sa],
      ...
      Ba = E[ja * 3 + 2],
      pa = re;
    ((pa.x = f[sa * 2 + 0]), (pa.y = f[sa * 2 + 1]));
    let Ra = pa.x,
      Xa = pa.y,
      na = i[sa * 2 + 0],
      Da = i[sa * 2 + 1],
      Sa = 1 - na - Da,
      Lb = w.decodeHeight(F, ua),
      Gb = w.decodeHeight(F, Wa),
      Vb = w.decodeHeight(F, Ba),
      La = Lb * na + Gb * Da + Vb * Sa;
    ((ea = Math.min(La, ea)), (da = Math.max(La, da)));
    let Yb = ba.lerp(aa, ta, Ra),
      Eb = ba.lerp(ia, ga, Xa),
      Zb = V.fromRadians(Yb, Eb, La, _c),
      ab = V.toCartesian(Zb, a, ae),
      vb = P.multiplyByPoint(ca, ab, ce);
    ((fa = u.minimumByComponent(vb, fa, fa)),
      (Y = u.maximumByComponent(vb, Y, Y)));
    let Ib;
    if (A) {
      let Ga = w.decodeNormal(F, ua, Gc),
        bb = w.decodeNormal(F, Wa, Vc),
        cb = w.decodeNormal(F, Ba, Yc),
        eb = u.fromElements(
          Ga.x * na + bb.x * Da + cb.x * Sa,
          Ga.y * na + bb.y * Da + cb.y * Sa,
          Ga.z * na + bb.z * Da + cb.z * Sa,
          Cb,
        );
      ((eb = u.normalize(eb, Cb)), (Ib = rb.octEncode(eb, me)));
    }
    let Ab;
    O && (Ab = (Ea.geodeticLatitudeToMercatorAngle(Eb) - ha) * oa);
    let Nb;
    (n && (Nb = a.geodeticSurfaceNormal(ab, se)),
      (Z = B.encode(q, Z, ab, pa, La, Ib, Ab, Nb)));
  }
  let va = ra.fromRectangle(t, ea, da, a, oe),
    ma = wa.fromVertices(q, B.center, U, ge),
    _a = new Mb(a).computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid(
      B.center,
      q,
      U,
      B.center,
  ...
  return (Sb(Oa, t, a, fa, Y, S, ca, b), Oa);
};
function Sb(c, o, e, g, j, b, r, E) {
  let { encoding: y } = c,
    F = y.stride,
    w = c.vertices,
    {
    ...
    n = k !== 1,
    t = c.vertexCountWithoutSkirts,
    a = t * F,
    h = w.length / F,
    f = h - t,
    i = c.indices,
    l = c.indexCountWithoutSkirts,
    m = c.westIndicesSouthToNorth,
    p = c.southIndicesEastToWest,
    x = c.eastIndicesNorthToSouth,
    N = c.northIndicesWestToEast;
  Ua.addSkirtIndicesWithFilledCorners(m, p, x, N, t, i, l);
  let v = 0,
    I = v + m.length,
    M = I + p.length,
    B = M + x.length,
  ...
  for (let G = 0; G < f; G++) {
    let R = 0;
    for (R = 0; R < 3 && !(G < D[R + 1]); R++);
    let q = U[R][G - D[R]],
      Z = y.decodeTextureCoordinates(w, q, Jb),
      S = 1e-4,
      ca = Z.x + z[R] * S,
      aa = Z.y + C[R] * S,
      ta = ba.lerp(o.west, o.east, ca),
      ia = ba.clamp(
        ba.lerp(o.south, o.north, aa),
        -ba.PI_OVER_TWO,
        +ba.PI_OVER_TWO,
      ),
      ha = y.decodeHeight(w, q) - E,
      la = V.fromRadians(ta, ia, ha, $c),
      oa = V.toCartesian(la, e, qb),
      ea;
    A && (ea = y.getOctEncodedNormal(w, q, Wb));
    let da;
    O && (da = y.decodeWebMercatorT(w, q));
    let fa;
    (n && (fa = e.geodeticSurfaceNormal(oa, Rb)),
      (a = y.encode(w, a, oa, Z, ha, ea, da, fa)));
    let Y = P.multiplyByPoint(r, oa, be);
    (u.minimumByComponent(Y, H, H), u.maximumByComponent(Y, T, T));
  }
  let L = Ha.fromCorners(H, T, le),
    $ = new Fa(
      y.center,
      L,
      X,
  ...
  if (y.quantization !== $.quantization) {
    let G = $,
      R = G.stride,
      q = new Float32Array(h * R),
      Z = 0;
    for (let S = 0; S < h; S++)
      Z = G.encode(
        q,
        Z,
        y.decodePosition(w, S, qb),
        y.decodeTextureCoordinates(w, S, Jb),
        y.decodeHeight(w, S),
        y.hasVertexNormals ? y.getOctEncodedNormal(w, S, Wb) : void 0,
        y.hasWebMercatorT ? y.decodeWebMercatorT(w, S) : void 0,
        y.hasGeodeticSurfaceNormals
          ? y.decodeGeodeticSurfaceNormal(w, S, Rb)
          : void 0,
      );
    ((c.vertices = q), (c.stride = R), (c.encoding = G));
  }
  return c;
}
var wb = 0,
  ...
  ye = 4,
  xe = new u(),
  Ee = [new u(), new u(), new u(), new u(), new u(), new u()],
  ve = [new K(), new K(), new K(), new K(), new K(), new K()],
  Ie = [new u(), new u(), new u(), new u(), new u(), new u()],
  Ae = [new K(), new K(), new K(), new K(), new K(), new K()];
function Xb(c, o, e, g) {
  switch (e) {
    case wb:
      return ba.sign(g.x - c.x);
    case yb:
      return ba.sign(o.x - g.x);
    case xb:
      return ba.sign(g.y - c.y);
    default:
      return ba.sign(o.y - g.y);
  }
}
function Ne(c, o, e, g, j, b) {
  let r, E, y;
  switch (e) {
    case wb:
      ((r = (c.x - g.x) / (j.x - g.x)), (E = c.x), (y = g.y + (j.y - g.y) * r));
      break;
    case yb:
      ((r = (o.x - g.x) / (j.x - g.x)), (E = o.x), (y = g.y + (j.y - g.y) * r));
      break;
    case xb:
      ((r = (c.y - g.y) / (j.y - g.y)), (E = g.x + (j.x - g.x) * r), (y = c.y));
      break;
    default:
      ((r = (o.y - g.y) / (j.y - g.y)), (E = g.x + (j.x - g.x) * r), (y = o.y));
      break;
  }
  return u.fromElements(E, y, r, b);
}
var Fe = {
  length: 0,
  coordinates: [new K(), new K(), new K(), new K(), new K(), new K()],
...
function Ue(c, o, e, g, j, b, r, E) {
  let y = 0,
    F = ve,
    w = Ee,
    A = 3,
    O = Ae;
  (K.clone(j, O[0]), K.clone(b, O[1]), K.clone(r, O[2]));
  let k = Ie;
  (u.fromElements(1, 0, 0, k[0]),
    u.fromElements(0, 1, 0, k[1]),
    u.fromElements(0, 0, 1, k[2]));
  for (let s = 0; s < o; s++) {
    let d = (c + s) % ye,
      n = F,
      t = w;
    ((F = O), (w = k), (y = A), (O = n), (k = t), (A = 0));
    let a = y - 1,
      h = F[a],
      f = w[a],
      i = Xb(e, g, d, h);
    for (let l = 0; l < y; l++) {
      let m = F[l],
        ...
        x = Xb(e, g, d, m);
      if (i * x === -1) {
        let N = Ne(e, g, d, h, m, xe),
          { x: v, y: I, z: M } = N,
          B = 1 - M,
          U = f.x * B + p.x * M,
          D = f.y * B + p.y * M,
          z = f.z * B + p.z * M;
        (K.fromElements(v, I, O[A]), u.fromElements(U, D, z, k[A]), A++);
      }
      (x >= 0 && (K.clone(m, O[A]), u.clone(p, k[A]), A++),
        (a = l),
        (h = m),
        (f = p),
        (i = x));
  ...
  E.length = A;
  for (let s = 0; s < A; s++)
    (K.clone(O[s], E.coordinates[s]),
      u.clone(k[s], E.barycentricCoordinates[s]));
  return E;
}
function Me(c, o, e, g, j, b, r, E) {
  return Ue(c ? (o ? xb : wb) : o ? yb : we, 2, e, g, j, b, r, E);
}
var Oe = [[], [0], [1], [0, 1], [2], [0, 2], [1, 2], [0, 1, 2]];
function Be(c, o, e, g, j, b, r, E, y, F, w, A, O, k, s) {
  let d = {},
    n = c ? 0.5 : 0,
    t = c ? 1 : 0.5,
    a = o ? 0.5 : 0,
  ...
  for (let m = 0; m < e; m += 3) {
    let p = g[m + 0],
      x = g[m + 1],
      N = g[m + 2],
      v = r.decodeTextureCoordinates(b, p, Xc),
      I = r.decodeTextureCoordinates(b, x, Sc),
      M = r.decodeTextureCoordinates(b, N, Lc),
      B = Me(c, o, f, i, v, I, M, Fe),
      U = B.length;
    if (U < 3) continue;
    let D = Rc;
    for (let T = 0; T < U; T++) {
      let W = B.barycentricCoordinates[T],
        X = W.x,
        L = W.y,
        $ = W.z,
        G = Math.ceil(X) | (Math.ceil(L) << 1) | (Math.ceil($) << 2),
        R = Oe[G],
        q,
        Z = !1;
      if (R.length === 1) {
        let S = R[0],
          aa = g[m + S];
        ((q = d[aa]), q === void 0 && ((Z = !0), (q = l++), (d[aa] = q)));
      } else if (R.length === 2) {
        let S = R[0],
          ca = R[1],
          aa = g[m + S],
          ta = g[m + ca],
          ia = B.barycentricCoordinates[(T + U - 1) % U],
          ga =
            Math.ceil(ia.x) | (Math.ceil(ia.y) << 1) | (Math.ceil(ia.z) << 2),
          ha = G === ga,
          la = Math.min(aa, ta),
          oa = Math.max(aa, ta),
          ea = j + 2 * (la * j + oa),
          ...
          Y = d[da],
          va = d[fa],
          ma = !ha == (Y === void 0 || va === void 0);
        if (((q = ma ? Y : va), q === void 0)) {
          ((Z = !0), (q = l++));
          let Ca = ma ? da : fa;
          d[Ca] = q;
        }
      ...
      if (((D[T] = q), Z)) {
        let S = m / 3;
        O.push(S);
        let ca = B.coordinates[T],
          aa = (ca.x - n) / (t - n),
          ta = (ca.y - a) / (h - a);
        (s.push(aa, ta),
          k.push(X, L),
          aa === 0 ? y.push(q) : aa === 1 && w.push(q),
          ta === 0 ? F.push(q) : ta === 1 && A.push(q));
      }
    }
    let z = D[0],
      C = D[1],
      H = D[2];
    E.push(z, C, H);
    for (let T = 3; T < U; T++) ((C = H), (H = D[T]), E.push(z, C, H));
  }
  (y.sort(function (m, p) {
    return s[m * 2 + 1] - s[p * 2 + 1];
  }),
    F.sort(function (m, p) {
      return s[p * 2 + 0] - s[m * 2 + 0];
    }),
    w.sort(function (m, p) {
      return s[p * 2 + 1] - s[m * 2 + 1];
    }),
    A.sort(function (m, p) {
      return s[m * 2 + 0] - s[p * 2 + 0];
    }));
}
var bf = pb;
export { bf as a };
