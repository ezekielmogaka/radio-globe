...
import { a as _ } from "./chunk-JZMSTCXO.js";
import { a as te } from "./chunk-SI3KZUTO.js";
import { h as Z, i as fe } from "./chunk-4NDD6KRQ.js";
import { a as ie, b as j } from "./chunk-5ELDAYCN.js";
import { a as se, b as ee } from "./chunk-ICY67TC6.js";
import { a as e, b as O } from "./chunk-G2EMNOST.js";
import { a as Q } from "./chunk-4VFKVGYI.js";
import { a as le } from "./chunk-3WJNS2B6.js";
import { e as $ } from "./chunk-XCN226AA.js";
var Ee = { ROUNDED: 0, MITERED: 1, BEVELED: 2 },
  G = Object.freeze(Ee);
var me = {};
function P(r, n) {
  if (!$(r)) throw new le("identifier is required.");
  $(me[r]) || ((me[r] = !0), console.warn(n ?? r));
}
P.geometryOutlines =
...
function v(r, n, a, o, t, c, f, l) {
  let m = Ve,
    s = Fe;
  ((H = fe.eastNorthUpToFixedFrame(r, t, H)),
    (m = j.multiplyByPointAsVector(H, He, m)),
    (m = e.normalize(m, m)));
  let S = je(m, n, r, t);
  ((oe = O.fromRotationZ(S, oe)),
    ...
    (H = j.multiplyTransformation(
      H,
      j.fromRotationTranslation(oe, he, Me),
      H,
    )));
  let d = Ne;
  d[0] = f;
...
var ge = new Z(),
  ye = new e(),
  we = new O();
function pe(r, n, a, o, t, c, f, l, m, s) {
  let S = e.angleBetween(e.subtract(n, r, I), e.subtract(a, r, W)),
    d = o === G.BEVELED ? 0 : Math.ceil(S / Q.toRadians(5)),
    x;
  t
    ? (x = O.fromQuaternion(
        Z.fromAxisAngle(e.negate(r, I), S / (d + 1), ge),
        we,
      ))
    : (x = O.fromQuaternion(Z.fromAxisAngle(r, S / (d + 1), ge), we));
  let i, g;
  if (((n = e.clone(n, ye)), d > 0)) {
    let D = s ? 2 : 1;
    for (let y = 0; y < d; y++)
...
R.computePositions = function (r, n, a, o, t) {
  ...
  for (let U = 1; U < i - 1; U++) {
    ...
    ((y = e.subtract(M, p, y)),
      (y = e.normalize(y, y)),
      (E = c.geodeticSurfaceNormal(p, E)));
    let L = e.multiplyByScalar(E, e.dot(y, E), Le);
    (e.subtract(y, L, L), e.normalize(L, L));
    let q = e.multiplyByScalar(E, e.dot(b, E), qe);
    if (
      (e.subtract(b, q, q),
      e.normalize(q, q),
      ...
      (K
        ...
        : ((B = e.add(p, e.multiplyByScalar(h, k * x, h), B)),
          ...
          (T = e.clone(z, T))),
        (b = e.negate(y, b)));
    } else ((g = v(T, u, s, g, c, N + d, 1, 1)), (T = p));
    ((N = A), (A = f[U + 1]), (p = M));
  }
  ((w[0] = e.clone(T, w[0])),
    (w[1] = e.clone(p, w[1])),
    ...
    (i = g.length));
  let xe = t ? i + D.length : i,
    J = new Float64Array(xe);
  return (J.set(g), t && J.set(D, i), J);
};
var ct = R;
export { G as a, ue as b, ct as c };
