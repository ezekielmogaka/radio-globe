...
import { a as mt } from "./chunk-6IHS2PAL.js";
import { a as P } from "./chunk-MHP75ZQC.js";
import { a as ht } from "./chunk-ITDFUUP5.js";
import { a as ft } from "./chunk-VSMOUEKV.js";
import { a as ot, c as st } from "./chunk-ICY67TC6.js";
import { a as g, b as it } from "./chunk-G2EMNOST.js";
import { a as M } from "./chunk-4VFKVGYI.js";
import { b as lt } from "./chunk-3WJNS2B6.js";
import { d as pt, e as h } from "./chunk-XCN226AA.js";
var at = pt(mt(), 1);
function xt(n) {
  return (
    lt.defined("value", n),
...
function yt(n, t, e) {
  for (let o = 0; o < e.length; o++) {
    ...
    if (e[o].projectionType === "WebMercator") {
      ...
      i = new ft(new st(r.x, r.y, r.z)).project(new ot(n, t, 0));
    } else ((i.x = n), (i.y = t));
    if (i.x > a.west && i.x < a.east && i.y > a.south && i.y < a.north)
      return It(i.x, i.y, e[o]);
  }
  return 0;
}
function At(n, t, e, o, a, i, r) {
  if (r) return;
  let s = yt(a.longitude, a.latitude, i);
  for (let c = 0; c < n; ++c) {
    let u = yt(
...
function St(n, t, e, o, a, i, r) {
  ...
  for (let c = 0; c < t.length; c += 3) bt(s.normals, c, t, e);
  return s;
}
function vt(n, t, e, o, a, i, r, s) {
  ...
  let c = [],
    ...
    b = [];
  h(t) && (n = t.length);
  let { indexArray: x, transparentVertexOffset: T } = Tt(
      n,
      t,
      i,
  ...
  let U,
    R = Bt(s.symbologyData, r, x, e, o);
  if (h(R)) {
    let y = new Blob([R], { type: "application/binary" });
    U = URL.createObjectURL(y);
  }
  let L = e.subarray(0, w * 3),
    gt = new Blob([L], { type: "application/binary" }),
    dt = URL.createObjectURL(gt),
  ...
  let G = h(i) ? Gt(i.subarray(0, w * 4)) : void 0,
    et;
  if (h(G)) {
  ...
  let V = {},
    j = {};
  ((V.POSITION = l.length),
    c.push({ uri: dt, byteLength: L.byteLength }),
    u.push({
      buffer: c.length - 1,
      byteOffset: 0,
...
function Ht(n) {
  let t = Mt(n.binaryData, n.schema, n.bufferInfo, n.featureData);
  (h(n.geoidDataList) &&
    ...
    h(t.uv0s) &&
      h(t["uv-region"]) &&
      Ot(t.vertexCount, t.uv0s, t["uv-region"]));
  let e;
