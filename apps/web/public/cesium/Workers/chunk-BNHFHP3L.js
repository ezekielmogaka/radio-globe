...
import { a as _ } from "./chunk-4UHVCH4T.js";
import { j as U } from "./chunk-4NDD6KRQ.js";
import { b as Z } from "./chunk-5ELDAYCN.js";
import { a as v, c as N } from "./chunk-ICY67TC6.js";
import { a as n, b as A } from "./chunk-G2EMNOST.js";
import { a as on } from "./chunk-4VFKVGYI.js";
import { a as en, b as h } from "./chunk-3WJNS2B6.js";
import { e as x } from "./chunk-XCN226AA.js";
function W(e) {
  ((this._ellipsoid = e ?? N.default),
...
W.prototype.project = function (e, t) {
...
W.prototype.unproject = function (e, t) {
  if (!x(e)) throw new en("cartesian is required");
  let o = this._oneOverSemimajorAxis,
    c = e.x * o,
    r = e.y * o,
    d = e.z;
  return x(t)
    ? ((t.longitude = c), (t.latitude = r), (t.height = d), t)
    : new v(c, r, d);
};
var V = W;
function sn(e, t) {
...
var cn = sn;
function a(e, t) {
  ((this.center = n.clone(e ?? n.ZERO)), (this.radius = t ?? 0));
}
var F = new n(),
  Y = new n(),
  I = new n(),
...
a.fromPoints = function (e, t) {
  ...
  let u = n.magnitudeSquared(n.subtract(f, c, b)),
    ...
    E = n.magnitudeSquared(n.subtract(m, d, b)),
    C = c,
    q = f,
    O = u;
  (i > O && ((O = i), (C = r), (q = s)), E > O && ((O = E), (C = d), (q = m)));
  let p = L;
  ((p.x = (C.x + q.x) * 0.5),
    (p.y = (C.y + q.y) * 0.5),
    (p.z = (C.z + q.z) * 0.5));
  ...
  let B = n.midpoint(j, P, tn),
    D = 0;
  for (y = 0; y < z; y++) {
    n.clone(e[y], o);
    let R = n.magnitude(n.subtract(o, B, b));
    R > D && (D = R);
  ...
  return (
    l < D
      ? (n.clone(p, t.center), (t.radius = l))
      : (n.clone(B, t.center), (t.radius = D)),
    t
  );
};
var rn = new V(),
...
a.fromRectangleWithHeights2D = function (e, t, o, c, r) {
  if ((x(r) || (r = new a()), !x(e)))
    return ((r.center = n.clone(n.ZERO, r.center)), (r.radius = 0), r);
  ((rn._ellipsoid = N.default),
    (t = t ?? rn),
    U.southwest(e, G),
    (G.height = o),
    U.northeast(e, X),
    (X.height = c));
  let d = t.project(G, un),
    f = t.project(X, xn),
    s = f.x - d.x,
    m = f.y - d.y,
    z = f.z - d.z;
...
a.fromRectangle3D = function (e, t, o, c) {
  if (((t = t ?? N.default), (o = o ?? 0), x(c) || (c = new a()), !x(e)))
    return ((c.center = n.clone(n.ZERO, c.center)), (c.radius = 0), c);
  let r = U.subsample(e, t, o, yn);
...
a.fromVertices = function (e, t, o, c) {
  ...
  ((t = t ?? n.ZERO),
    (o = o ?? 3),
    h.typeOf.number.greaterThanOrEquals("stride", o, 3));
  let r = $;
  ...
  let E = n.magnitudeSquared(n.subtract(m, d, b)),
  ...
  let j = n.magnitudeSquared(n.subtract(p, l, b)),
    P = Math.sqrt(j),
    B = H;
  ((B.x = d.x), (B.y = f.y), (B.z = s.z));
  let D = nn;
  ((D.x = m.x), (D.y = z.y), (D.z = y.z));
  let R = n.midpoint(B, D, tn),
    M = 0;
  for (i = 0; i < u; i += o) {
  ...
  return (
    P < M
      ? (n.clone(l, c.center), (c.radius = P))
      : (n.clone(R, c.center), (c.radius = M)),
    c
  );
};
a.fromEncodedCartesianVertices = function (e, t, o) {
  if (
    (x(o) || (o = new a()),
    !x(e) || !x(t) || e.length !== t.length || e.length === 0)
  )
  ...
  let i = n.magnitudeSquared(n.subtract(s, r, b)),
    ...
    O = s,
    p = i;
  (E > p && ((p = E), (q = d), (O = m)), C > p && ((p = C), (q = f), (O = z)));
  let S = L;
  ((S.x = (q.x + O.x) * 0.5),
    (S.y = (q.y + O.y) * 0.5),
    (S.z = (q.z + O.z) * 0.5));
  ...
  let B = nn;
  ((B.x = s.x), (B.y = m.y), (B.z = z.z));
  let D = n.midpoint(P, B, tn),
    R = 0;
  for (u = 0; u < y; u += 3) {
    ((c.x = e[u] + t[u]),
      (c.y = e[u + 1] + t[u + 1]),
      (c.z = e[u + 2] + t[u + 2]));
    let M = n.magnitude(n.subtract(c, D, b));
    M > R && (R = M);
  ...
  return (
    j < R
      ? (n.clone(S, o.center), (o.radius = j))
      : (n.clone(D, o.center), (o.radius = R)),
    o
  );
};
a.fromCornerPoints = function (e, t, o) {
  (h.typeOf.object("corner", e),
    h.typeOf.object("oppositeCorner", t),
    x(o) || (o = new a()));
...
a.fromBoundingSpheres = function (e, t) {
  ...
  for (r = 0; r < o; r++) {
    let s = e[r];
    f = Math.max(f, n.distance(d, s.center, ln) + s.radius);
  }
  return ((t.radius = f), t);
};
var pn = new n(),
...
a.fromOrientedBoundingBox = function (e, t) {
  ...
  let o = e.halfAxes,
    c = A.getColumn(o, 0, pn),
    r = A.getColumn(o, 1, hn),
    d = A.getColumn(o, 2, zn);
  return (
    n.add(c, r, c),
    n.add(c, d, c),
    (t.center = n.clone(e.center, t.center)),
    (t.radius = n.magnitude(c)),
    t
  );
};
var Sn = new n(),
...
a.clone = function (e, t) {
  if (x(e))
    return x(t)
      ? ((t.center = n.clone(e.center, t.center)), (t.radius = e.radius), t)
      : new a(e.center, e.radius);
};
a.packedLength = 4;
a.pack = function (e, t, o) {
  (h.typeOf.object("value", e), h.defined("array", t), (o = o ?? 0));
  let c = e.center;
  return ((t[o++] = c.x), (t[o++] = c.y), (t[o++] = c.z), (t[o] = e.radius), t);
};
a.unpack = function (e, t, o) {
  (h.defined("array", e), (t = t ?? 0), x(o) || (o = new a()));
  let c = o.center;
...
a.union = function (e, t, o) {
  (h.typeOf.object("left", e),
    h.typeOf.object("right", t),
    x(o) || (o = new a()));
  let c = e.center,
    r = e.radius,
    d = t.center,
...
a.intersectPlane = function (e, t) {
  ...
  return d < -c ? _.OUTSIDE : d < c ? _.INTERSECTING : _.INSIDE;
};
a.transform = function (e, t, o) {
  return (
    ...
    x(o) || (o = new a()),
    (o.center = Z.multiplyByPoint(t, e.center, o.center)),
    (o.radius = Z.getMaximumScale(t) * e.radius),
    o
  );
};
var jn = new n();
a.distanceSquaredTo = function (e, t) {
  ...
  let o = n.subtract(e.center, t, jn),
...
a.computePlaneDistances = function (e, t, o, c) {
  (h.typeOf.object("sphere", e),
    ...
    x(c) || (c = new cn()));
  let r = n.subtract(e.center, t, bn),
    d = n.dot(o, r);
...
var an = new n(),
  ...
  Tn = new v(),
  fn = new Array(8);
for (let e = 0; e < 8; ++e) fn[e] = new n();
var dn = new V();
a.projectTo2D = function (e, t, o) {
  (h.typeOf.object("sphere", e), (dn._ellipsoid = N.default), (t = t ?? dn));
  let c = t.ellipsoid,
    r = e.center,
    d = e.radius,
    f;
  n.equals(r, n.ZERO)
    ? (f = n.clone(n.UNIT_X, an))
    : (f = c.geodeticSurfaceNormal(r, an));
  let s = n.cross(n.UNIT_Z, f, qn);
  n.normalize(s, s);
  let m = n.cross(f, s, Mn);
  (n.normalize(m, m),
    n.multiplyByScalar(f, d, f),
    n.multiplyByScalar(m, d, m),
    n.multiplyByScalar(s, d, s));
  let z = n.negate(m, Rn),
    y = n.negate(s, Cn),
    u = fn,
    i = u[0];
  ...
  for (let p = 0; p < E; ++p) {
    let S = u[p];
    n.add(r, S, S);
    let l = c.cartesianToCartographic(S, Tn);
    t.project(l, S);
  }
...
a.equals = function (e, t) {
  return (
    e === t ||
    (x(e) && x(t) && n.equals(e.center, t.center) && e.radius === t.radius)
  );
};
