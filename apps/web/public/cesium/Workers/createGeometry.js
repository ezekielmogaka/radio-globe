...
import { a as k } from "./chunk-CAF7VC2F.js";
import { a as w } from "./chunk-ITDFUUP5.js";
import "./chunk-VSMOUEKV.js";
...
import "./chunk-G2EMNOST.js";
import "./chunk-4VFKVGYI.js";
import { a as y } from "./chunk-3WJNS2B6.js";
import { a, b as p, e as r } from "./chunk-XCN226AA.js";
var g = p({
  ...
  "./createVerticesFromCesium3DTilesTerrain.js": () =>
    import("./createVerticesFromCesium3DTilesTerrain.js"),
  ...
  "./gaussianSplatTextureGenerator.js": () =>
    import("./gaussianSplatTextureGenerator.js"),
  "./incrementallyBuildTerrainPicker.js": () =>
    import("./incrementallyBuildTerrainPicker.js"),
  ...
  "./upsampleVerticesFromCesium3DTilesTerrain.js": () =>
...
async function b(s, t) {
  ...
  return r(e)
    ...
    : r(t)
      ...
      : (typeof exports == "object"
          ? (e = a(`Workers/${s}`))
          : (e = (r(t) ? await import(t) : await g(`./${s}.js`)).default),
        (c[s] = e),
        e);
}
async function h(s, t) {
  ...
  for (let o = 0; o < n; o++) {
    let i = e[o],
      ...
      u = i.moduleName,
      l = i.modulePath;
    if (r(u) && r(l)) throw new y("Must only set moduleName or modulePath");
    r(u) || r(l) ? (f[o] = b(u, l).then((d) => d(m, i.offset))) : (f[o] = m);
  }
  return Promise.all(f).then(function (o) {
    return k.packCreateGeometryResults(o, t);
  });
}
var G = w(h);
export { G as default };
