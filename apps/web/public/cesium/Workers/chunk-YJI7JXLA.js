...
import { a as tt } from "./chunk-DAX2P4DI.js";
import { a as jt } from "./chunk-RKB2XVMW.js";
import { b as Lt } from "./chunk-SPC72PTY.js";
import { a as Et } from "./chunk-HVWI7BO6.js";
import { a as j } from "./chunk-KSX6TRAS.js";
import { a as dt, b as D, c as B, d as U } from "./chunk-BELR52CD.js";
import { a as _t, c as ot } from "./chunk-BNHFHP3L.js";
import { a as Ut } from "./chunk-4UHVCH4T.js";
import { a as pt, b as H } from "./chunk-5ELDAYCN.js";
import { a as F } from "./chunk-N6BI774S.js";
import { a as Mt, b as V } from "./chunk-ICY67TC6.js";
import { a as r, b as gt, c as Ot } from "./chunk-G2EMNOST.js";
import { a as N } from "./chunk-4VFKVGYI.js";
import { a as I, b as ft } from "./chunk-3WJNS2B6.js";
import { e as f } from "./chunk-XCN226AA.js";
var Yt = new r(),
  Zt = new r(),
  Xt = new r();
function pe(t, e, n, s, i) {
  ...
  if (f(e.z)) {
    ...
    if (V.equalsEpsilon(t, e, N.EPSILON14)) return r.clone(r.UNIT_X, i);
    if (V.equalsEpsilon(t, n, N.EPSILON14)) return r.clone(r.UNIT_Y, i);
    if (V.equalsEpsilon(t, s, N.EPSILON14)) return r.clone(r.UNIT_Z, i);
    ((c = V.subtract(n, e, Yt)),
      (o = V.subtract(s, e, Zt)),
      (a = V.subtract(t, e, Xt)),
      (p = V.dot(c, c)),
...
Nt.tipsify = function (t) {
  ...
  function o(C, z, q, R, G, M, J) {
    ...
    for (; Pt < q.length; ) {
      let lt = q[Pt];
      (R[lt].numLiveTriangles &&
        ((_ = 0),
        G - R[lt].timeStamp + 2 * R[lt].numLiveTriangles <= z &&
          (_ = G - R[lt].timeStamp),
        (_ > St || St === -1) && ((St = _), (Y = lt))),
        ++Pt);
    }
    return Y === -1 ? c(R, M, C, J) : Y;
  }
  if (!f(e)) throw new I("indices is required.");
  let a = e.length;
  if (a < 3 || a % 3 !== 0)
...
function de(t) {
  let e = t.length,
    ...
    i = 0;
  for (let c = 0; c < e; c += 3, i += 6) It(s, i, t[c], t[c + 1], t[c + 2]);
  return s;
}
function me(t) {
  let e = t.length;
  if (e >= 3) {
    ...
    It(s, 0, t[0], t[1], t[2]);
    let i = 6;
    for (let c = 3; c < e; ++c, i += 6) It(s, i, t[c - 1], t[c], t[c - 2]);
    return s;
  }
...
function he(t) {
  if (t.length > 0) {
    let e = t.length - 1,
      ...
      i = t[0],
      c = 0;
    for (let o = 1; o < e; ++o, c += 6) It(s, c, i, t[o], t[o + 1]);
    return s;
  }
  return new Uint16Array();
}
k.toWireframe = function (t) {
...
k.createLineSegmentsForVectors = function (t, e, n) {
  if (((e = e ?? "normal"), !f(t))) throw new I("geometry is required.");
  ...
  let p,
    u = t.boundingSphere;
  return (
    f(u) && (p = new ot(u.center, u.radius + n)),
    new B({
      attributes: {
        position: new U({
...
k.createAttributeLocations = function (t) {
  if (!f(t)) throw new I("geometry is required.");
  let e = [
      "position",
      "positionHigh",
...
k.reorderForPreVertexCache = function (t) {
  if (!f(t)) throw new I("geometry is required.");
    ...
    for (let l in m)
      if (m.hasOwnProperty(l) && f(m[l]) && f(m[l].values)) {
        let h = m[l],
          ...
          S = F.createTypedArray(h.componentDatatype, u * b);
        for (; v < e; ) {
          let x = s[v];
...
k.reorderForPostVertexCache = function (t, e) {
  if (!f(t)) throw new I("geometry is required.");
  let n = t.indices;
...
k.fitToUnsignedShortIndices = function (t) {
  if (!f(t)) throw new I("geometry is required.");
  if (
    f(t.indices) &&
...
var Jt = new r(),
  we = new Mt();
k.projectTo2D = function (t, e, n, s, i) {
  if (!f(t)) throw new I("geometry is required.");
  ...
  if (t.attributes[e].componentDatatype !== F.DOUBLE)
    throw new I(
...
var zt = { high: 0, low: 0 };
k.encodeAttribute = function (t, e, n, s) {
  if (!f(t)) throw new I("geometry is required.");
  if (!f(e)) throw new I("attributeName is required.");
...
var wt = new H(),
  vt = new gt();
k.transformToWorldCoordinates = function (t) {
  ...
  return (
    f(s) && (t.geometry.boundingSphere = ot.transform(s, e, s)),
    ...
    if (i.hasOwnProperty(c) && f(i[c]) && f(i[c].values)) {
      ...
      p &&
        (s[c] = new U({
          ...
          values: F.createTypedArray(o.componentDatatype, a),
        }));
    }
  return s;
}
...
function Rt(t, e) {
  ...
  return new B({
    ...
    indices: y,
    primitiveType: u,
    boundingSphere: f(v) ? new ot(v, b) : void 0,
  });
}
k.combineInstances = function (t) {
  if (!f(t) || t.length < 1)
    throw new I(
  ...
  let i = [];
  return (
    e.length > 0 && i.push(Rt(e, "geometry")),
    n.length > 0 &&
      (i.push(Rt(n, "westHemisphereGeometry")),
      i.push(Rt(n, "eastHemisphereGeometry"))),
    i
  );
};
var Z = new r(),
...
var xe = new r(),
  Kt = new r(),
  Te = new r();
k.computeTangentAndBitangent = function (t) {
  if (!f(t)) throw new I("geometry is required.");
  let e = t.attributes,
    n = t.indices;
...
k.compressVertices = function (t) {
  ...
  if (f(e)) {
    ...
    for (n = 0; n < s; ++n) {
      ...
      ((yt = tt.octEncodeInRange(W, 65535, yt)),
        (O[L++] = yt.x),
        (O[L++] = yt.y));
    }
    return (
  ...
  for (n = 0; n < s; ++n) {
    a &&
      (V.fromArray(h, n * 2, ht), (A[E++] = tt.compressTextureCoordinates(ht)));
    let P = n * 3;
    o && f(y) && f(v)
      ? (r.fromArray(l, P, W),
        r.fromArray(y, P, Qt),
        r.fromArray(v, P, te),
        tt.octPack(W, Qt, te, ht),
        (A[E++] = ht.x),
        (A[E++] = ht.y))
      : (o && (r.fromArray(l, P, W), (A[E++] = tt.octEncodeFloat(W))),
        d && (r.fromArray(y, P, W), (A[E++] = tt.octEncodeFloat(W))),
        m && (r.fromArray(v, P, W), (A[E++] = tt.octEncodeFloat(W))));
  }
  return (
    (t.attributes.compressedAttributes = new U({
      componentDatatype: F.FLOAT,
...
var et = new r(),
  ...
  it = new r(),
  st = new r(),
  Vt = { positions: new Array(7), indices: new Array(9) };
function Ne(t, e, n) {
  ...
  return (
    ...
    (p.length = 3),
    (o === 1 || o === 2) &&
      ((p[3] = et), (p[4] = nt), (p[5] = it), (p[6] = st), (p.length = 7)),
    Vt
  );
}
function ne(t, e) {
  ...
  for (let i in n)
    if (n.hasOwnProperty(i) && f(n[i]) && f(n[i].values)) {
      let c = n[i];
      c.values = F.createTypedArray(c.componentDatatype, c.values);
    }
  let s = B.computeNumberOfVertices(t);
  return (
    (t.indices = j.createTypedArray(s, t.indices)),
    e && (t.boundingSphere = ot.fromVertices(n.position.values)),
    t
  );
}
function ut(t) {
...
var ze = kt(pt, 4),
  ...
  Ct = new r(),
  qe = new r();
function xt(t, e, n, s, i, c, o, a, p, u, d, m, l, h, y, v) {
  if (!f(c) && !f(o) && !f(a) && !f(p) && !f(u) && h === 0) return;
  let b = r.fromArray(i, t * 3, bt),
    S = r.fromArray(i, e * 3, Gt),
    x = r.fromArray(i, n * 3, Ct),
    w = Ht(s, b, S, x, qe);
  if (f(w)) {
    if ((f(c) && At(t, e, n, w, c, m.normal.values, v, !0), f(u))) {
      let A = r.fromArray(u, t * 3, bt),
      ...
      (!r.equals(A, r.ZERO) || !r.equals(E, r.ZERO) || !r.equals(P, r.ZERO)
        ...
        : ((O = bt), (O.x = 0), (O.y = 0), (O.z = 0)),
        r.pack(O, m.extrudeDirection.values, v * 3));
    }
    if (
      (f(d) && De(t, e, n, w, d, m.applyOffset.values, v),
      f(o) && At(t, e, n, w, o, m.tangent.values, v, !0),
      f(a) && At(t, e, n, w, a, m.bitangent.values, v, !0),
      f(p) && ae(t, e, n, w, p, m.st.values, v),
      h > 0)
    )
      for (let A = 0; A < h; A++) {
        let E = l[A];
        Re(t, e, n, w, v, y[E], m[E]);
      }
  }
}
function Re(t, e, n, s, i, c, o) {
...
function ie(t) {
  let e = t.geometry,
    ...
    d = e.indices,
    m = [];
  for (let O in n) n.hasOwnProperty(O) && !Ve[O] && f(n[O]) && m.push(O);
  let l = m.length,
    h = ut(e),
    y = ut(e),
    v,
    ...
    if (f(q) && q.positions.length > 3) {
      ...
      for (let J = 0; J < M; ++J) {
        ...
        (_.y < 0
          ...
          (x = K(v, b, S, d, Y < 3 ? w + Y : -1, _)),
          xt(O, L, g, _, s, i, o, c, a, p, u, v, m, l, n, x));
      }
    } else
      (f(q) &&
        ...
        T.y < 0
          ...
          : ((v = h.attributes), (b = h.indices), (S = E)),
        (x = K(v, b, S, d, w, T)),
        xt(O, L, g, T, s, i, o, c, a, p, u, v, m, l, n, x),
        (x = K(v, b, S, d, w + 1, C)),
        xt(O, L, g, C, s, i, o, c, a, p, u, v, m, l, n, x),
        (x = K(v, b, S, d, w + 2, z)),
        xt(O, L, g, z, s, i, o, c, a, p, u, v, m, l, n, x));
  }
  Ft(t, y, h);
}
var ue = Et.fromPointNormal(r.ZERO, r.UNIT_Y),
  Ge = new r(),
  Ce = new r();
function at(t, e, n, s, i, c, o) {
  if (!f(o)) return;
  let a = r.fromArray(s, t * 3, bt);
...
function Ue(t) {
  ...
  for (m = 0; m < v; m += 4) {
    ...
    let A = u.attributes,
      ...
      P = d.attributes,
      O = d.indices,
      L = Lt.lineSegmentPlane(x, w, ue, Fe);
    if (f(L)) {
      y = !0;
      let g = r.multiplyByScalar(r.UNIT_Y, _e, ke);
      x.y < 0 &&
        (r.negate(g, g),
        (A = d.attributes),
        (E = d.indices),
      ...
      if (((q /= r.magnitudeSquared(r.subtract(w, x, Bt))), f(p))) {
        let R = pt.fromArray(p, b * 4, re),
          G = pt.fromArray(p, S * 4, re),
          M = N.lerp(R.x, G.x, q),
          J = N.lerp(R.y, G.y, q),
          Y = N.lerp(R.z, G.z, q),
          _ = N.lerp(R.w, G.w, q);
        for (l = b * 4; l < b * 4 + 8; ++l) A.color.values.push(p[l]);
        for (
      ...
      if (f(a)) {
        let R = V.fromArray(a, b * 2, oe),
          G = V.fromArray(a, (m + 3) * 2, Be),
          M = N.lerp(R.x, G.x, q);
        for (l = b * 2; l < b * 2 + 4; ++l) A.st.values.push(a[l]);
        for (
          A.st.values.push(M, R.y),
            A.st.values.push(M, G.y),
            P.st.values.push(M, R.y),
      ...
      if (f(p)) for (l = m * 4; l < m * 4 + 16; ++l) g.color.values.push(p[l]);
      ((h = g.position.values.length / 3 - 4),
        T.push(h, h + 2, h + 1),
        T.push(h + 1, h + 2, h + 3));
    }
  }
  (y && (ce(d), ce(u)), Ft(t, d, u));
}
k.splitLongitude = function (t) {
  if (!f(t)) throw new I("instance is required.");
  let e = t.geometry,
    n = e.boundingSphere;
  if (
    ...
    (n.center.x - n.radius > 0 ||
      ot.intersectPlane(n, Et.ORIGIN_ZX_PLANE) !== Ut.INTERSECTING)
  )
    return t;
  if (e.geometryType !== dt.NONE)
